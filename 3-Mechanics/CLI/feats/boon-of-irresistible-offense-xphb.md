...
When you roll a 20 on the `dice:d20|noform|noparens|avg` (`d20`) for an attack roll, you can deal extra damage to the target equal to the ability score increased by this feat. The extra damage's type is the same as the attack's type.