...
The target can take a [Study](/3-Mechanics/CLI/actions.md#Study) action to examine the phantasm with an Intelligence ([Investigation](/3-Mechanics/CLI/skills.md#Investigation)) check against your spell save DC. If the check succeeds, the target realizes that the phantasm is an illusion, and the spell ends.
