...
- **Instant Health.** You allow yourself and up to twenty creatures that you can see to regain all [Hit Points](/3-Mechanics/CLI/variant-rules/hit-points-xphb.md), and you end all effects on them listed in the [Greater Restoration](/3-Mechanics/CLI/spells/greater-restoration-xphb.md) spell.  
- **Resistance.** You grant up to ten creatures that you can see [Resistance](/3-Mechanics/CLI/variant-rules/resistance-xphb.md) to one damage type that you choose. This [Resistance](/3-Mechanics/CLI/variant-rules/resistance-xphb.md) is permanent.  
