...
You conjure a mass of sticky webbing at a point within range. The webs fill a 20-foot Cube there for the duration. The webs are [Difficult Terrain](/3-Mechanics/CLI/variant-rules/difficult-terrain-xphb.md), and the area within them is [Lightly Obscured](/3-Mechanics/CLI/variant-rules/lightly-obscured-xphb.md).
