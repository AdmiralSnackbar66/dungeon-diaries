...
- **Truesight.** You have [Truesight](/3-Mechanics/CLI/senses.md#Truesight) out to 240 feet.  
...
- **Spellcasting.** The hand has 8 charges and regains `dice:1d4+4|noform|noparens|avg` (`1d4 + 4`) expended charges daily at dawn. You can cast a spell on the [Hand of Vecna](/3-Mechanics/CLI/items/hand-of-vecna-xdmg.md) Spells table from the hand (save DC 18). The table indicates how many charges you must expend to cast the spell. Each time you cast a spell from it, the hand casts [Suggestion](/3-Mechanics/CLI/spells/suggestion-xphb.md) on you (save DC 18; no [Concentration](/3-Mechanics/CLI/conditions.md#Concentration) required), demanding that you commit an evil act. The hand might have a specific act in mind or leave it up to you.  
