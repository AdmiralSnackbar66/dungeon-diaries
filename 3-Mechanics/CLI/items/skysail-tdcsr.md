...
Additionally, while in contact with the skysail, you can use an action to cast the [fly](3-Mechanics/CLI/spells/fly-xphb.md) spell on yourself, with a duration of 1 minute and requiring no [concentration](3-Mechanics/CLI/rules/conditions.md#Concentration).
...
When the skysail is not in use, its wings can be retracted, and its pole can be used as a [quarterstaff](3-Mechanics/CLI/items/quarterstaff-xphb.md).
