...
- **Range**: 100/400
- **Properties**: [Ammunition](3-Mechanics/CLI/rules/item-properties.md#Ammunition), [Heavy](3-Mechanics/CLI/rules/item-properties.md#Heavy), [Loading](3-Mechanics/CLI/rules/item-properties.md#Loading), [Two-Handed](3-Mechanics/CLI/rules/item-properties.md#Two-Handed), [Vestige of Divergence](3-Mechanics/CLI/rules/item-properties.md#Vestige%20of%20Divergence)
- **Weight**: 18.0 lbs.

This shadow-touched [heavy crossbow](3-Mechanics/CLI/items/heavy-crossbow-xphb.md) once served as the weapon of choice for the legendary assassin Todora. Though few know this, Condemner is now in the possession of an equally infamous assassin named "Ixrattu Khar".
...
- You cast [fog cloud](3-Mechanics/CLI/spells/fog-cloud-xphb.md) centered on the target's space.  
- You cast [silence](3-Mechanics/CLI/spells/silence-xphb.md) centered on the target's space.  
...
-     - You cast [hold person](3-Mechanics/CLI/spells/hold-person-xphb.md) on the target (save DC 15).    
...
-     - You cast the [blight](3-Mechanics/CLI/spells/blight-xphb.md) spell on the target (save DC 17).    
