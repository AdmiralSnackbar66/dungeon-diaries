...
You can hurl multiple beads, or even the whole necklace, at one time. When you do so, increase the damage of the Fireball by `dice:1d6|noform|noparens|avg` (`1d6`) for each bead after the first (maximum `dice:12d6|noform|noparens|avg` (`12d6`)).

*Source: Dungeon Master's Guide (2024) p. 280. Available in the <span title='Systems Reference Document (5.2)'>SRD</span>*