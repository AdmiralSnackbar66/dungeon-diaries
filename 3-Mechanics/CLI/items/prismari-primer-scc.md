...
The Prismari Primer is a magic textbook created at Strixhaven's Prismari College. The primer has 3 charges, and it regains `dice:1d3|noform|noparens|avg` (`d3`) expended charges daily at dawn. If you make a Dexterity ([Acrobatics](/3-Mechanics/CLI/skills.md#Acrobatics)) or a Charisma ([Performance](/3-Mechanics/CLI/skills.md#Performance)) check while holding the primer, you can expend 1 charge to give yourself a `dice:1d4|noform|noparens|avg` (`d4`) bonus to the check, immediately after you roll the `dice:d20|noform|noparens|avg` (`d20`).
