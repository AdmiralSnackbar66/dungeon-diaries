...
- **Equipment.** A [bottle of black ink](/3-Mechanics/CLI/items/ink-xphb.md), an [ink pen](/3-Mechanics/CLI/items/ink-pen-xphb.md), a book about plant identification, an [iron pot](/3-Mechanics/CLI/items/iron-pot-xphb.md), an [herbalism kit](/3-Mechanics/CLI/items/herbalism-kit-xphb.md), a school uniform, and a [pouch](/3-Mechanics/CLI/items/pouch-xphb.md) containing 15 gp  
...
| Spell Level | Spells |
|-------------|--------|
| 1st | [Cure Wounds](/3-Mechanics/CLI/spells/cure-wounds-xphb.md), [Inflict Wounds](/3-Mechanics/CLI/spells/inflict-wounds-xphb.md) |
| 2nd | [Lesser Restoration](/3-Mechanics/CLI/spells/lesser-restoration-xphb.md), [Wither and Bloom](/3-Mechanics/CLI/spells/wither-and-bloom-scc.md) |
| 3rd | [Revivify](/3-Mechanics/CLI/spells/revivify-xphb.md), [Vampiric Touch](/3-Mechanics/CLI/spells/vampiric-touch-xphb.md) |
| 4th | [Blight](/3-Mechanics/CLI/spells/blight-xphb.md), [Death Ward](/3-Mechanics/CLI/spells/death-ward-xphb.md) |
| 5th | [Antilife Shell](/3-Mechanics/CLI/spells/antilife-shell-xphb.md), [Greater Restoration](/3-Mechanics/CLI/spells/greater-restoration-xphb.md) |
^witherbloom-spells
...
Druids and warlocks make up most of Witherbloom's student body. A few wizards (mostly those who study the School of Necromancy) and clerics (including those with the Divine Domains of [Life](/3-Mechanics/CLI/classes/cleric-xphb-life-domain-xphb.md) or Nature) also find their home in Witherbloom.
...
When you make your character, you may roll once on the [Witherbloom Trinkets](/3-Mechanics/CLI/items/witherbloom-trinket-scc.md) table, instead of on the [Trinkets table](/3-Mechanics/CLI/items/trinket-xphb.md) in the "Player's Handbook", for your starting trinket.