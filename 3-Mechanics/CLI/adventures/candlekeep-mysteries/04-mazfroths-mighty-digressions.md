...
With Korvala as their new leader, the pack began working on a way to resurrect Nidalia. It soon became clear that wouldn't be a simple task. After all, the [resurrection](/3-Mechanics/CLI/spells/resurrection-xphb.md) spell requires both a diamond worth at least 1,000 gp and the services of a sufficiently powerful spellcaster.
...
If the characters talk to the Avowed about the incident they experienced involving *Mazfroth's Mighty Digressions*, the monks offer them a [helm of comprehending languages](/3-Mechanics/CLI/items/helm-of-comprehending-languages-xdmg.md) as a reward for finding out who is responsible for the deception.
...
On the fourth night of their journey, the party is attacked by the [wererat](/3-Mechanics/CLI/bestiary/monstrosity/wererat-xmm.md) Mushika and three [giant rats](/3-Mechanics/CLI/bestiary/beast/giant-rat-xmm.md). Mushika bears nasty scars from his time in the thieves' guilds of Baldur's Gate, and has since turned to easier prey along the Coast Way. While the giant rats attack, Mushika stands back in hybrid form and uses his hand crossbow. He tries to flee if he's reduced to half his hit points or fewer or if all three giant rats are defeated.
...
- Coppers to Crowns, an "antiques" shop selling a miscellany of trinkets and oddities (roll `dice:2d4|noform|noparens|avg` (`2d4`) times on the [Trinkets table](/3-Mechanics/CLI/items/trinket-xphb.md) in the "Player's Handbook"). Each trinket costs `dice:2d10|noform|noparens|avg` (`2d10`) cp.  
...
- Wizards of the Wide, a tent bursting with dozens of arcane foci and [spell scrolls](/3-Mechanics/CLI/items/spell-scroll-xdmg.md), including scrolls of [comprehend languages](/3-Mechanics/CLI/spells/comprehend-languages-xphb.md), [detect magic](/3-Mechanics/CLI/spells/detect-magic-xphb.md), [feather fall](/3-Mechanics/CLI/spells/feather-fall-xphb.md), [find familiar](/3-Mechanics/CLI/spells/find-familiar-xphb.md), [mage armor](/3-Mechanics/CLI/spells/mage-armor-xphb.md), [magic missile](/3-Mechanics/CLI/spells/magic-missile-xphb.md), [shield](/3-Mechanics/CLI/spells/shield-xphb.md), and [unseen servant](/3-Mechanics/CLI/spells/unseen-servant-xphb.md) (25 gp each).  
...
Amberdune Books is always supervised by two [jackalweres](/3-Mechanics/CLI/bestiary/fiend/jackalwere-xmm.md) in humanoid form. At sunrise, those on the first shift set up the stall with Korvala, and at sundown the workers bring their unsold wares back to the pack's hideout in the Blackgate neighborhood.
...
Korvala takes her duties as the owner of Amberdune Books seriously. She denies all accusations of deception with curt professionalism and threatens to call for the guards if characters are too aggressive. A successful DC 15 Wisdom ([Insight](/3-Mechanics/CLI/skills.md#Insight)) check reveals that Korvala isn't being entirely truthful. To avoid making a scene, she invites characters who see through her lies back to the Amberdune Pack's hideout as long as they are willing to talk peacefully.

##### Tailing the Jackalweres

The characters can also find the Amberdune hideout by following pack members after their shift. If the characters succeed on a DC 13 group Dexterity ([Stealth](/3-Mechanics/CLI/skills.md#Stealth)) check, the jackalweres don't notice that they're being followed. If they do notice the characters, they hurry to alert Korvala but don't engage unless the characters do so first. See "Roleplaying the Jackalweres" below for more information.
...
There are seven [jackalweres](/3-Mechanics/CLI/bestiary/fiend/jackalwere-xmm.md) in the Amberdune Pack, including the leader, Korvala. The other pack members are as follows:
...
The jackalweres like to relax and chat with each other in this room, particularly during and after meals together. The faded rug is actually a [rug of smothering](/3-Mechanics/CLI/bestiary/construct/animated-rug-of-smothering-xmm.md) friendly to the jackalweres, which defends them if they command it to. If no jackalweres are present in this area, the rug attacks intruders. It stops fighting if one of the jackalweres commands it to.

##### Development

Noise from fighting the rug of smothering causes Marliza, a [jackalwere](/3-Mechanics/CLI/bestiary/fiend/jackalwere-xmm.md) in hybrid form, to run into the room from area A2, scimitar at the ready. This jackalwere is willing to command the rug to stop if the characters explain themselves.
...
The Amberdune Pack cooks meals in this kitchen before eating in the common room (area A1). There are currently two [jackalweres](/3-Mechanics/CLI/bestiary/fiend/jackalwere-xmm.md) in the room, Marliza and Theryn (see "Amberdune Pack" earlier in the adventure for more information on the pack members). Theryn, in his humanoid form, chops vegetables for a soup with a cleaver (which functions as a scimitar), while Marliza leans against a wall in hybrid form. They are happily chatting together. Noise in area A1 prompts Marliza to investigate.
...
Unless she is awakened by sounds of combat, the [jackalwere](/3-Mechanics/CLI/bestiary/fiend/jackalwere-xmm.md) Avani (in humanoid form) is taking a nap on one of the cots. Characters moving through this room must succeed on a DC 10 Dexterity ([Stealth](/3-Mechanics/CLI/skills.md#Stealth)) check or wake her up. This check is made with disadvantage if characters made a commotion elsewhere in the hideout. Beneath each cot is an unlocked trunk full of personal belongings. Nothing of value can be found here.
...
- Using a ritual taught to her by Nidalia, Korvala can create creatures known as gingwatzims. (Korvala claims to be under the effect of a [geas](/3-Mechanics/CLI/spells/geas-xphb.md) spell cast by Nidalia that prevents her from sharing this knowledge. This is a lie. Regardless, Korvala will not divulge the ritual.)  
...
This room contains all the legitimate and commonplace books that the Amberdune Pack sells, as well as a small portion of the money it has obtained. Zan, a [jackalwere](/3-Mechanics/CLI/bestiary/fiend/jackalwere-xmm.md) in hybrid form, is looking through the bookshelves to decide which books should be sold at the market the following day (see "Amberdune Pack" above for more information on the pack members).

##### False Storage Trunk

The top wooden trunk is actually a [mimic](/3-Mechanics/CLI/bestiary/monstrosity/mimic-xmm.md) that used to live in Nidalia's lair, protecting her from intruders. The mimic has a symbiotic relationship with the Amberdune Pack and a sense of kinship toward its fellow shapechangers. The jackalweres feed it leftovers, but it has become hungry from the lack of substantial meals in Blackgate. Unless a jackalwere tells it not to, it will attempt to eat any character who touches it.
...
If the party has difficulty finding the hidden vault in area A6, any of the characters can make a DC 10 Intelligence ([Investigation](/3-Mechanics/CLI/skills.md#Investigation)) check. On a success, they arrive at one of the realizations from the following list. If the check succeeds by 5 or more, they come up with all three:
...
If characters return to Candlekeep with the books, the Avowed reward them with a [helm of comprehending languages](/3-Mechanics/CLI/items/helm-of-comprehending-languages-xdmg.md). Valor and Yalerion are grateful for the party's efforts to solve the mystery. Both seekers could be useful allies in the future.
