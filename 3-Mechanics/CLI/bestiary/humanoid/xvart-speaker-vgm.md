...
"traits":
  - "desc": "The xvart can take the Disengage action as a bonus action on each of\
      \ its turns."
    "name": "Low Cunning"
  - "desc": "The xvart has advantage on Strength ([Athletics](/3-Mechanics/CLI/skills.md#Athletics))\
      \ checks to shove a creature if at least one of the xvart's allies is within\
      \ 5 feet of the target and the ally isn't [incapacitated](/3-Mechanics/CLI/conditions.md#Incapacitated)."
...
"source":
  - "VGM"
"image": "/3-Mechanics/CLI/bestiary/humanoid/token/xvart-speaker-vgm.webp"
```
^statblock
