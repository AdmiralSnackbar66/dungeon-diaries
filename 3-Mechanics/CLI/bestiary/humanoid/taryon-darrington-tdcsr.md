...
"alignment": "Unaligned"
"ac": !!int "15"
"ac_class": "[+1 breastplate](3-Mechanics/CLI/items/1-armor-xdmg.md)"
"hp": !!int "127"
"hit_dice": "15d8 + 30 + 30"
"stats":
- !!int "12"
...
- !!int "8"
- !!int "15"
"speed": "40 ft., fly 50 ft. (with [broom of flying](3-Mechanics/CLI/items/broom-of-flying-xdmg.md))"
"saves":
  "Intelligence": !!int "9"
  "Constitution": !!int "7"
"skillsaves":
...
- "desc": "Tary is a 15th-level spellcaster. His spellcasting ability is Intelligence\
    ...
    \ [prestidigitation](3-Mechanics/CLI/spells/prestidigitation-xphb.md), [ray of\
    \ frost](3-Mechanics/CLI/spells/ray-of-frost-xphb.md) (3d8)\n\n1st level (4\
    \ slots): [detect magic](3-Mechanics/CLI/spells/detect-magic-xphb.md), [heroism](3-Mechanics/CLI/spells/heroism-xphb.md),\
    ...
    \ [branding smite](3-Mechanics/CLI/spells/shining-smite-xphb.md), [see invisibility](3-Mechanics/CLI/spells/see-invisibility-xphb.md),\
    \ [warding bond](3-Mechanics/CLI/spells/warding-bond-xphb.md)\n\n3rd level (3\
    \ slots): [dispel magic](3-Mechanics/CLI/spells/dispel-magic-xphb.md), [fly](3-Mechanics/CLI/spells/fly-xphb.md),\
    \ [haste](3-Mechanics/CLI/spells/haste-xphb.md), [magic circle](3-Mechanics/CLI/spells/magic-circle-xphb.md),\
    \ [revivify](3-Mechanics/CLI/spells/revivify-xphb.md)\n\n4th level (2 slots):\
    \ [banishment](3-Mechanics/CLI/spells/banishment-xphb.md), [fabricate](3-Mechanics/CLI/spells/fabricate-xphb.md),\
...
- "desc": "[Doty](3-Mechanics/CLI/bestiary/npc/doty-x-tdcsr.md) moves and acts on\
  ...
  "name": "Doty"
- "desc": "Tary has advantage on Constitution saving throws made to maintain [concentration](3-Mechanics/CLI/rules/conditions.md#Concentration)\
    \ on spells."
  "name": "Focused"
- "desc": "Tary wears a [helm of brilliance](3-Mechanics/CLI/items/helm-of-brilliance-xdmg.md),\
    \ a [robe of useful items](3-Mechanics/CLI/items/robe-of-useful-items-xdmg.md),\
    \ and a [ring of the ram](3-Mechanics/CLI/items/ring-of-the-ram-xdmg.md). He carries\
    \ a [rod of mercurial form](3-Mechanics/CLI/items/rod-of-mercurial-form-tdcsr.md),\
    \ as well as a [bag of holding](3-Mechanics/CLI/items/bag-of-holding-xdmg.md),\
    \ 1d4 + 4 [beads of force](3-Mechanics/CLI/items/bead-of-force-xdmg.md), a [broom\
    \ of flying](3-Mechanics/CLI/items/broom-of-flying-xdmg.md), and a [chime of opening](3-Mechanics/CLI/items/chime-of-opening-xdmg.md)."
...
- "desc": "Tary throws a [bead of force](3-Mechanics/CLI/items/bead-of-force-xdmg.md)\
    ...
    \ sphere."
  "name": "[Bead of Force](3-Mechanics/CLI/items/bead-of-force-xdmg.md)"
"reactions":
