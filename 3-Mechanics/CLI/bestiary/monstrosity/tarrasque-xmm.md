...
*Source: Monster Manual (2024) p. 305. Available in the <span title='Systems Reference Document (5.2)'>SRD</span>*  
...
- "desc": "The tarrasque makes one Bite attack and three other attacks, using Claw\
  ...
  "name": "Multiattack"
- "desc": "Melee Attack Roll: +19, reach 15 ft. Hit: 36 (4d12 + 10) Piercing damage,\
    \ and the target has the [Grappled](/3-Mechanics/CLI/conditions.md#Grappled) condition\
    \ (escape DC 20). Until the grapple ends, the target has the [Restrained](/3-Mechanics/CLI/conditions.md#Restrained)\
...
- "desc": "Strength Saving Throw: DC 27, one Large or smaller creature [Grappled](/3-Mechanics/CLI/conditions.md#Grappled)\
    ...
    \ and [Restrained](/3-Mechanics/CLI/conditions.md#Restrained) conditions and can't\
    \ teleport, it has [Total Cover](/3-Mechanics/CLI/variant-rules/cover-xphb.md)\
    ...
    \ feet of the tarrasque and has the [Prone](/3-Mechanics/CLI/conditions.md#Prone)\
    \ condition. If the tarrasque dies, any swallowed creature no longer has the [Restrained](/3-Mechanics/CLI/conditions.md#Restrained)\
...
- "desc": "The tarrasque moves up to its [Speed](/3-Mechanics/CLI/variant-rules/speed-xphb.md).\
    ...
    \ in a 60-foot [Emanation](/3-Mechanics/CLI/variant-rules/emanation-area-of-effect-xphb.md)\
