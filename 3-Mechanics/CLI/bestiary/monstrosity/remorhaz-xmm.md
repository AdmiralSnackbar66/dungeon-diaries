...
*Source: Monster Manual (2024) p. 258. Available in the <span title='Systems Reference Document (5.2)'>SRD</span>*  
...
- "desc": "At the end of each of the remorhaz's turns, each creature in a 5-foot [Emanation](/3-Mechanics/CLI/variant-rules/emanation-area-of-effect-xphb.md)\
  ...
  "name": "Heat Aura"
"actions":
- "desc": "Melee Attack Roll: +11, reach 10 ft. Hit: 18 (2d10 + 7) Piercing damage\
...
- "desc": "Strength Saving Throw: DC 19, one Large or smaller creature [Grappled](/3-Mechanics/CLI/conditions.md#Grappled)\
    ...
    \ and [Restrained](/3-Mechanics/CLI/conditions.md#Restrained) conditions, it has\
    ...
    \ within 5 feet of the remorhaz and has the [Prone](/3-Mechanics/CLI/conditions.md#Prone)\
    \ condition. If the remorhaz dies, any swallowed creature no longer has the [Restrained](/3-Mechanics/CLI/conditions.md#Restrained)\
