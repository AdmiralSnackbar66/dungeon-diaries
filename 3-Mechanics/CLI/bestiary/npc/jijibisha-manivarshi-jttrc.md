...
"traits":
  - "desc": "Jijibisha's innate spellcasting ability is Charisma (spell save DC 17).\
      ...
      3/day each: [dimension door](/3-Mechanics/CLI/spells/dimension-door-xphb.md),\
      \ [fear](/3-Mechanics/CLI/spells/fear-xphb.md), [wall of fire](/3-Mechanics/CLI/spells/wall-of-fire-xphb.md)\n\
      \n1/day each: [fire storm](/3-Mechanics/CLI/spells/fire-storm-xphb.md),\
...
"actions":
  ...
  - "desc": "Jijibisha's eyes sparkle with opalescent light as it targets one creature\
      ...
      \ must succeed on a DC 17 Wisdom saving throw against this magic or be [charmed](/3-Mechanics/CLI/conditions.md#Charmed)\
      \ until the end of Jijibisha's next turn. The [charmed](/3-Mechanics/CLI/conditions.md#Charmed)\
      \ target is [stunned](/3-Mechanics/CLI/conditions.md#Stunned). If the target's\
