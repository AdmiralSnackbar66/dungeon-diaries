...
"actions":
  ...
  - "desc": "Each creature of Sholeh's choice that is within 120 feet of Sholeh and\
      \ aware of it must succeed on a DC 18 Wisdom saving throw or become [frightened](/3-Mechanics/CLI/conditions.md#Frightened)\
  ...
  - "desc": "Sholeh uses one of the following breath weapons:\n\n- Fire Breath.\
      ...
      \ in that area must succeed on a DC 21 Constitution saving throw or fall [unconscious](/3-Mechanics/CLI/conditions.md#Unconscious)\
  ...
  - "desc": "Sholeh magically polymorphs into a humanoid or beast that has a challenge\
      ...
      \ or borne by the new form (Sholeh's choice).\n\nIn a new form, Sholeh retains\
    ...
    "name": "Change Shape"
"legendary_actions":
  - "desc": "Sholeh makes a Wisdom ([Perception](/3-Mechanics/CLI/skills.md#Perception))\
      \ check."
    "name": "Detect"
  ...
  - "desc": "Sholeh beats its wings. Each creature within 15 feet of Sholeh must succeed\
      ...
      \ and be knocked [prone](/3-Mechanics/CLI/conditions.md#Prone). Sholeh can then\
