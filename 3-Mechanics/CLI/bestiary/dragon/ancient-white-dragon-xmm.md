...
*Source: Monster Manual (2024) p. 330. Available in the <span title='Systems Reference Document (5.2)'>SRD</span>*  
...
"legendary_actions":
- "desc": "Constitution Saving Throw: DC 20, each creature in a 30-foot-radius [Sphere](/3-Mechanics/CLI/variant-rules/sphere-area-of-effect-xphb.md)\
    \ centered on a point the dragon can see within 120 feet. Failure: 14 (4d6)\
    \ Cold damage, and the target's [Speed](/3-Mechanics/CLI/variant-rules/speed-xphb.md)\
...
- "desc": "- Frigid Cold. The area within 1 mile of the lair is an area of [extreme\
    ...
    \ have its [Speed](/3-Mechanics/CLI/variant-rules/speed-xphb.md) reduced by 10\
    \ feet for 1 hour.  "
  "name": ""
