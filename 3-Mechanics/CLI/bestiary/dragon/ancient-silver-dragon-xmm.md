...
*Source: Monster Manual (2024) p. 280. Available in the <span title='Systems Reference Document (5.2)'>SRD</span>*  
...
- "desc": "The dragon makes three Rend attacks. It can replace one attack with a use\
    ...
    \ (level 2 version)."
  "name": "Multiattack"
- "desc": "Melee Attack Roll: +17, reach 15 ft. Hit: 19 (2d8 + 10) Slashing damage\
...
- "desc": "Dexterity Saving Throw: DC 23, each creature in a 60-foot-long, 10-foot-wide\
    ...
    \ 14 (4d6) Cold damage, and the target is pushed up to 30 feet straight away from\
    \ the dragon. Success: Half damage only. Failure or Success: The dragon can't\
