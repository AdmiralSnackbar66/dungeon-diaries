...
*Source: Monster Manual (2024) p. 79. Available in the <span title='Systems Reference Document (5.2)'>SRD</span>*  
...
- "desc": "The dragon makes three Rend attacks. It can replace one attack with a use\
    ...
    \ (level 4 version)."
  "name": "Multiattack"
- "desc": "Melee Attack Roll: +11, reach 10 ft. Hit: 17 (2d10 + 6) Slashing damage\
...
- "desc": "Charisma Saving Throw: DC 17, one creature the dragon can see within\
    ...
    \ the number rolled from the [D20 Test](/3-Mechanics/CLI/variant-rules/d20-test-xphb.md).\
...
- "desc": "- Chatty Critters. Tiny Beasts magically gain the ability to speak\
    ...
    \ the lair and rolls a 1 on a [D20 Test](/3-Mechanics/CLI/variant-rules/d20-test-xphb.md),\
