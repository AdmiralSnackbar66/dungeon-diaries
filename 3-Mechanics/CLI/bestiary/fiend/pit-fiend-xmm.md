...
*Source: Monster Manual (2024) p. 243. Available in the <span title='Systems Reference Document (5.2)'>SRD</span>*  
...
- "desc": "The pit fiend emanates an aura in a 20-foot [Emanation](/3-Mechanics/CLI/variant-rules/emanation-area-of-effect-xphb.md)\
    ...
    \ aura. Failure: The target has the [Frightened](/3-Mechanics/CLI/conditions.md#Frightened)\
...
- "desc": "Melee Attack Roll: +14, reach 10 ft. Hit: 18 (3d6 + 8) Piercing damage.\
    ...
    \ condition. While [Poisoned](/3-Mechanics/CLI/conditions.md#Poisoned), the target\
