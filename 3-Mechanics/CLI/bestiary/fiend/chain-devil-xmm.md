...
*Source: Monster Manual (2024) p. 68. Available in the <span title='Systems Reference Document (5.2)'>SRD</span>*  
...
- "desc": "The devil conjures a fiery chain to bind a creature. Dexterity Saving\
    ...
    \ + 4) Fire damage, and the target has the [Restrained](/3-Mechanics/CLI/conditions.md#Restrained)\
...
- "desc": "Trigger: A creature the devil can see starts its turn within 30 feet of\
    ...
    \ triggering creature. Failure: The target has the [Frightened](/3-Mechanics/CLI/conditions.md#Frightened)\
