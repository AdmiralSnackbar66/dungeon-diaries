...
*Source: Monster Manual (2024) p. 319. Available in the <span title='Systems Reference Document (5.2)'>SRD</span>*  
...
- "desc": "Constitution Saving Throw: DC 15, each creature in a 20-foot [Emanation](/3-Mechanics/CLI/variant-rules/emanation-area-of-effect-xphb.md)\
    ...
    \ on itself on a success. While [Poisoned](/3-Mechanics/CLI/conditions.md#Poisoned),\
