...
"traits":
  - "desc": "While all three members of a hag coven are within 30 feet of one another,\
      ...
      \ person](/3-Mechanics/CLI/spells/charm-person-xphb.md), [witch bolt](/3-Mechanics/CLI/spells/witch-bolt-xphb.md)\n\
      ...
      \ slots): [dispel magic](/3-Mechanics/CLI/spells/dispel-magic-xphb.md), [glyph\
      \ of warding](/3-Mechanics/CLI/spells/glyph-of-warding-xphb.md), [slow](/3-Mechanics/CLI/spells/slow-xphb.md)\n\
      \n4th level (3 slots): [blight](/3-Mechanics/CLI/spells/blight-xphb.md),\
      \ [polymorph](/3-Mechanics/CLI/spells/polymorph-xphb.md)\n\n5th level (2 slots):\
      \ [dominate person](/3-Mechanics/CLI/spells/dominate-person-xphb.md), [seeming](/3-Mechanics/CLI/spells/seeming-xphb.md)\n\
      \n6th level (1 slots): [Otto's irresistible dance](/3-Mechanics/CLI/spells/ottos-irresistible-dance-xphb.md)\n\
  ...
  - "desc": "The hag can mimic animal sounds and humanoid voices. A creature that\
      ...
      \ ([Insight](/3-Mechanics/CLI/skills.md#Insight)) check."
    "name": "Mimicry"
"actions":
  ...
  - "desc": "The hag magically turns [invisible](/3-Mechanics/CLI/conditions.md#Invisible)\
      ...
      \ on a spell). While [invisible](/3-Mechanics/CLI/conditions.md#Invisible),\
      \ she leaves no physical evidence of her passage, so she can be tracked only\
      \ by magic. Any equipment she wears or carries is [invisible](/3-Mechanics/CLI/conditions.md#Invisible)\
      \ with her."
