...
*Source: Monster Manual (2024) p. 317. Available in the <span title='Systems Reference Document (5.2)'>SRD</span>*  
...
- "desc": "If the vampire drops to 0 [Hit Points](/3-Mechanics/CLI/variant-rules/hit-points-xphb.md)\
    ...
    \ Points](/3-Mechanics/CLI/variant-rules/hit-points-xphb.md) in mist form, it\
    ...
    \ form and has the [Paralyzed](/3-Mechanics/CLI/conditions.md#Paralyzed) condition\
    \ until it regains any [Hit Points](/3-Mechanics/CLI/variant-rules/hit-points-xphb.md),\
...
- "desc": "The vampire has these weaknesses:\n\n- Forbiddance. The vampire can't\
    ...
    \ [Disadvantage](/3-Mechanics/CLI/variant-rules/disadvantage-xphb.md) on attack\
...
- "desc": "Constitution Saving Throw: DC 17, one creature within 5 feet that is\
    ...
    \ to that amount. A Humanoid reduced to 0 [Hit Points](/3-Mechanics/CLI/variant-rules/hit-points-xphb.md)\
...
- "desc": "If the vampire isn't in sunlight or running water, it shape-shifts into\
    ...
    \ its size and [Speed](/3-Mechanics/CLI/variant-rules/speed-xphb.md), are unchanged.\n\
    ...
    \ liquid. It has [Resistance](/3-Mechanics/CLI/variant-rules/resistance-xphb.md)\
...
- "desc": "- Children of the Night. The vampire exerts influence over the animals\
    ...
    \ the lair is [Lightly Obscured](/3-Mechanics/CLI/variant-rules/lightly-obscured-xphb.md)\
