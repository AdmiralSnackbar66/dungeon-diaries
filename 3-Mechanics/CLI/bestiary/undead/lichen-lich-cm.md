...
"actions":
  ...
  - "desc": "The lich casts one of the following spells using Wisdom as the spellcasting\
      ...
      \ [dispel magic](/3-Mechanics/CLI/spells/dispel-magic-xphb.md), [speak with\
      \ plants](/3-Mechanics/CLI/spells/speak-with-plants-xphb.md), [transport via\
      \ plants](/3-Mechanics/CLI/spells/transport-via-plants-xphb.md)"
    "name": "Spellcasting"
"legendary_actions":
  ...
  - "desc": "The lich targets one [poisoned](/3-Mechanics/CLI/conditions.md#Poisoned)\
      ...
      \ 19 Constitution saving throw or fall [unconscious](/3-Mechanics/CLI/conditions.md#Unconscious)\
...
"lair_actions":
  ...
  - "desc": "- Poisonous spores fill a 10-foot cube that the lich can see within 120\
      ...
      \ or be [poisoned](/3-Mechanics/CLI/conditions.md#Poisoned) until the end of\
      \ its next turn. The cloud lasts for 1 minute or until it is dispersed by a\
      \ strong wind.  \n- The lich commands the might of its diseased grove, creating\
      \ a shambling mound. The shambling mound appears in an unoccupied space within\
      \ 30 feet of the lich, acts on its own initiative count, and obeys the lich's\
      \ commands. The shambling mound dies after 1 hour or when the lich uses this\
      ...
      \ on a DC 19 Strength saving throw or be [restrained](/3-Mechanics/CLI/conditions.md#Restrained)\
