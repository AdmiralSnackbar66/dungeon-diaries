...
| 5 | A [deep dragon wyrmling](deep-dragon-wyrmling-ftd.md) with an experimental bent has created a "garden" of [gray oozes](gray-ooze-xmm.md). |
| 6 | An orphaned [deep dragon wyrmling](deep-dragon-wyrmling-ftd.md) is cared for by a [giant constrictor snake](giant-constrictor-snake-xmm.md) that is the recipient of a druid's [awaken](3-Mechanics/CLI/spells/awaken-xphb.md) spell. |
^deep-dragon-wyrmling-connections