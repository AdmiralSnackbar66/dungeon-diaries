...
| 04-06 | `dice:1d6\|noform\|noparens\|avg` (`1d6`) [bandits](/3-Mechanics/CLI/bestiary/humanoid/bandit-xmm.md) |
| 07 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [vultures](/3-Mechanics/CLI/bestiary/beast/vulture-xmm.md) |
| 08 | `dice:1d10\|noform\|noparens\|avg` (`1d10`) [commoners](/3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md) |
...
| 17-18 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [guards](/3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md) with `dice:1d2\|noform\|noparens\|avg` (`1d2`) [mastiffs](/3-Mechanics/CLI/bestiary/beast/mastiff-xmm.md) and 1 [mule](/3-Mechanics/CLI/bestiary/beast/mule-xmm.md) |
...
| 26 | 1 [pseudodragon](/3-Mechanics/CLI/bestiary/dragon/pseudodragon-xmm.md) or `dice:1d3\|noform\|noparens\|avg` (`1d3`) [giant owls](/3-Mechanics/CLI/bestiary/celestial/giant-owl-xmm.md) |
...
| 36 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [swarms of bats](/3-Mechanics/CLI/bestiary/beast/swarm-of-bats-xmm.md) or `dice:1d3\|noform\|noparens\|avg` (`1d3`) [swarms of ravens](/3-Mechanics/CLI/bestiary/beast/swarm-of-ravens-xmm.md) |
...
| 41 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [elk](/3-Mechanics/CLI/bestiary/beast/elk-xmm.md) |
| 42 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [winged kobolds](/3-Mechanics/CLI/bestiary/dragon/winged-kobold-xmm.md) with `dice:1d6\|noform\|noparens\|avg` (`1d6`) [kobolds](/3-Mechanics/CLI/bestiary/dragon/kobold-warrior-xmm.md) |
...
| 48-49 | 1 [brown bear](/3-Mechanics/CLI/bestiary/beast/brown-bear-xmm.md) or `dice:1d3\|noform\|noparens\|avg` (`1d3`) [boars](/3-Mechanics/CLI/bestiary/beast/boar-xmm.md) |
...
| 59 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [half-ogres](/3-Mechanics/CLI/bestiary/giant/ogrillon-ogre-xmm.md) |
...
| 65-66 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [dire wolves](/3-Mechanics/CLI/bestiary/beast/dire-wolf-xmm.md) |
...
| 80 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [giant boars](/3-Mechanics/CLI/bestiary/beast/giant-boar-xmm.md) |
| 81 | 1 [gnoll pack lord](/3-Mechanics/CLI/bestiary/fiend/gnoll-pack-lord-xmm.md) with `dice:1d3\|noform\|noparens\|avg` (`1d3`) [giant hyenas](/3-Mechanics/CLI/bestiary/beast/giant-hyena-xmm.md) |
...
| 84 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [orogs](/3-Mechanics/CLI/bestiary/humanoid/berserker-xmm.md) or `dice:1d4\|noform\|noparens\|avg` (`1d4`) [berserkers](/3-Mechanics/CLI/bestiary/humanoid/berserker-xmm.md) |
...
| 89 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [griffons](/3-Mechanics/CLI/bestiary/monstrosity/griffon-xmm.md) |
| 90 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [perytons](/3-Mechanics/CLI/bestiary/monstrosity/peryton-xmm.md) or `dice:1d4\|noform\|noparens\|avg` (`1d4`) [pegasi](/3-Mechanics/CLI/bestiary/celestial/pegasus-xmm.md) |
| 91-96 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [trolls](/3-Mechanics/CLI/bestiary/giant/troll-xmm.md) |
