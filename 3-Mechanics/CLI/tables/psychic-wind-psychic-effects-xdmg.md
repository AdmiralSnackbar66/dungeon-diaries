...
| 18–20 | You have the [Unconscious](/3-Mechanics/CLI/conditions.md#Unconscious) condition for `dice:1d10\|noform\|noparens\|avg\|text(5)` (`1d10`) hours; the effect on you ends if you take damage or if another creature takes an action to shake you awake. |
^psychic-wind-psychic-effects