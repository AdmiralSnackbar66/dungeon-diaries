...
| 02 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [giant spiders](/3-Mechanics/CLI/bestiary/beast/giant-spider-xmm.md) or `dice:1d4\|noform\|noparens\|avg` (`1d4`) [giant toads](/3-Mechanics/CLI/bestiary/beast/giant-toad-xmm.md) |
...
| 12 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [minotaur skeletons](/3-Mechanics/CLI/bestiary/undead/minotaur-skeleton-xmm.md) |
...
| 28 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [gibbering mouthers](/3-Mechanics/CLI/bestiary/aberration/gibbering-mouther-xmm.md) |
| 29-30 | `dice:4d4\|noform\|noparens\|avg` (`4d4`) [hobgoblins](/3-Mechanics/CLI/bestiary/fey/hobgoblin-warrior-xmm.md) |
| 31-32 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [carrion crawlers](/3-Mechanics/CLI/bestiary/monstrosity/carrion-crawler-xmm.md) |
| 33-34 | 1 [black pudding](/3-Mechanics/CLI/bestiary/ooze/black-pudding-xmm.md) |
| 35 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [ochre jellies](/3-Mechanics/CLI/bestiary/ooze/ochre-jelly-xmm.md) |
| 36-40 | A patch of mold that appears yellow when light is directed toward it |
| 41 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [nothics](/3-Mechanics/CLI/bestiary/aberration/nothic-xmm.md) |
| 42-43 | `dice:2d8+1\|noform\|noparens\|avg` (`2d8 + 1`) [gas spores](/3-Mechanics/CLI/bestiary/plant/gas-spore-fungus-xmm.md) |
| 44-45 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [gelatinous cubes](/3-Mechanics/CLI/bestiary/ooze/gelatinous-cube-xmm.md) |
...
| 57 | 1 [kuo-toa monitor](/3-Mechanics/CLI/bestiary/aberration/kuo-toa-monitor-xmm.md) with `dice:1d4\|noform\|noparens\|avg` (`1d4`) [kuo-toa whips](/3-Mechanics/CLI/bestiary/aberration/kuo-toa-whip-xmm.md) and `dice:1d8+1\|noform\|noparens\|avg` (`1d8 + 1`) [kuo-toa](/3-Mechanics/CLI/bestiary/aberration/kuo-toa-xmm.md) |
| 58 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [water weirds](/3-Mechanics/CLI/bestiary/elemental/water-weird-xmm.md) |
| 59 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [ghasts](/3-Mechanics/CLI/bestiary/undead/ghast-xmm.md) with `dice:1d10\|noform\|noparens\|avg` (`1d10`) [ghouls](/3-Mechanics/CLI/bestiary/undead/ghoul-xmm.md) |
...
| 63 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [wights](/3-Mechanics/CLI/bestiary/undead/wight-xmm.md) |
| 64 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [doppelgangers](/3-Mechanics/CLI/bestiary/monstrosity/doppelganger-xmm.md) |
| 65 | `dice:2d8\|noform\|noparens\|avg` (`2d8`) [fire snakes](/3-Mechanics/CLI/bestiary/elemental/salamander-fire-snake-xmm.md) |
| 66 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [spectators](/3-Mechanics/CLI/bestiary/aberration/spectator-xmm.md) |
| 67 | 1 [orc Eye of Gruumsh](/3-Mechanics/CLI/bestiary/humanoid/cultist-fanatic-xmm.md) with `dice:1d4\|noform\|noparens\|avg` (`1d4`) [orogs](/3-Mechanics/CLI/bestiary/humanoid/berserker-xmm.md) and `dice:2d10+3\|noform\|noparens\|avg` (`2d10 + 3`) [orcs](/3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md) |
| 68 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [vampire spawn](/3-Mechanics/CLI/bestiary/undead/vampire-spawn-xmm.md) |
| 69 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [hook horrors](/3-Mechanics/CLI/bestiary/monstrosity/hook-horror-xmm.md) or `dice:1d4\|noform\|noparens\|avg` (`1d4`) [minotaurs](/3-Mechanics/CLI/bestiary/monstrosity/minotaur-of-baphomet-xmm.md) |
| 70 | `dice:3d6\|noform\|noparens\|avg` (`3d6`) [quaggoth spore servants](/3-Mechanics/CLI/bestiary/plant/myconid-spore-servant-xmm.md) |
| 71-72 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [grells](/3-Mechanics/CLI/bestiary/aberration/grell-xmm.md) |
...
| 74 | `dice:1d10\|noform\|noparens\|avg` (`1d10`) [gargoyles](/3-Mechanics/CLI/bestiary/elemental/gargoyle-xmm.md) |
...
| 78 | `dice:1d6\|noform\|noparens\|avg` (`1d6`) [ettins](/3-Mechanics/CLI/bestiary/giant/ettin-xmm.md) or `dice:1d4\|noform\|noparens\|avg` (`1d4`) [trolls](/3-Mechanics/CLI/bestiary/giant/troll-xmm.md) |
| 79 | `dice:1d8+1\|noform\|noparens\|avg` (`1d8 + 1`) [phase spiders](/3-Mechanics/CLI/bestiary/monstrosity/phase-spider-xmm.md) |
| 80 | 1 [fomorian](/3-Mechanics/CLI/bestiary/giant/fomorian-xmm.md) or `dice:1d3\|noform\|noparens\|avg` (`1d3`) [cyclopes](/3-Mechanics/CLI/bestiary/giant/cyclops-sentry-xmm.md) |
| 81 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [earth elementals](/3-Mechanics/CLI/bestiary/elemental/earth-elemental-xmm.md) |
...
| 84 | `dice:1d10\|noform\|noparens\|avg` (`1d10`) [hell hounds](/3-Mechanics/CLI/bestiary/fiend/hell-hound-xmm.md) |
| 85 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [drow elite warriors](/3-Mechanics/CLI/bestiary/humanoid/gladiator-xmm.md) |
| 86 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [chimeras](/3-Mechanics/CLI/bestiary/monstrosity/chimera-xmm.md) |
| 87 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [salamanders](/3-Mechanics/CLI/bestiary/elemental/salamander-xmm.md) |
...
| 90 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [driders](/3-Mechanics/CLI/bestiary/monstrosity/drider-xmm.md) |
...
| 94 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [drow mages](/3-Mechanics/CLI/bestiary/humanoid/bandit-deceiver-xmm.md) |
| 95 | 1 [spirit naga](/3-Mechanics/CLI/bestiary/fiend/spirit-naga-xmm.md) |
| 96 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [mind flayers](/3-Mechanics/CLI/bestiary/aberration/mind-flayer-xmm.md) |
