...
As a [Bonus Action](/3-Mechanics/CLI/variant-rules/bonus-action-xphb.md), you can expend one use of your Channel Divinity to augment your athleticism. For 1 hour, you have [Advantage](/3-Mechanics/CLI/variant-rules/advantage-xphb.md) on Strength ([Athletics](/3-Mechanics/CLI/skills.md#Athletics)) and Dexterity ([Acrobatics](/3-Mechanics/CLI/skills.md#Acrobatics)) checks, and the distance of your Long and High Jumps increases by 10 feet (this extra distance costs movement as normal).
