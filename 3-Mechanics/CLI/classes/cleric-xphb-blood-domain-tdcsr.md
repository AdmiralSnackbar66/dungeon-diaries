...
> <tr class="class-progression"><td class"level">3rd</td><td class"pb">+2</td><td class"feature"><a href='#Blood Domain (Level 3)' class='internal-link'>Blood Domain</a>, <a href='#Channel Divinity: Crimson Bond (Level 3)' class='internal-link'>Channel Divinity: Crimson Bond</a></td></tr>
...
| Cleric Level | Spells |
|--------------|--------|
| 1st | [false life](3-Mechanics/CLI/spells/false-life-xphb.md), [sleep](3-Mechanics/CLI/spells/sleep-xphb.md) |
| 3rd | [hold person](3-Mechanics/CLI/spells/hold-person-xphb.md), [ray of enfeeblement](3-Mechanics/CLI/spells/ray-of-enfeeblement-xphb.md) |
| 5th | [haste](3-Mechanics/CLI/spells/haste-xphb.md), [slow](3-Mechanics/CLI/spells/slow-xphb.md) |
| 7th | [blight](3-Mechanics/CLI/spells/blight-xphb.md), [stoneskin](3-Mechanics/CLI/spells/stoneskin-xphb.md) |
| 9th | [dominate person](3-Mechanics/CLI/spells/dominate-person-xphb.md), [hold monster](3-Mechanics/CLI/spells/hold-monster-xphb.md) |
^blood-domain-spells
...
### Channel Divinity: Crimson Bond (Level 3)

Starting at 2nd level, you can use your Channel Divinity to form a supernatural bond with a creature you can see, or with a creature for which you possess a blood sample. This bond lasts for 1 hour or until your [concentration](3-Mechanics/CLI/rules/conditions.md#Concentration) is broken (as if concentrating on a spell).
...
- [Interact with an object](3-Mechanics/CLI/rules/actions.md#Utilize)  
...
An affected living creature makes a new saving throw at the end of each of its turns, ending the effect on itself on a success. For any target, your control lasts for 1 minute or until your [concentration](3-Mechanics/CLI/rules/conditions.md#Concentration) is broken (as if concentrating on a spell).
