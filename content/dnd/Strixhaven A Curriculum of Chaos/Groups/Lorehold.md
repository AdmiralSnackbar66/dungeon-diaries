...
#### Faculty
<!-- QueryToSerialize: TABLE WITHOUT ID file.link as "Name", race AS "Species", Class FROM "content" WHERE (college = "Lorehold") WHERE (role = "Faculty") -->
<!-- SerializedQuery: TABLE WITHOUT ID file.link as "Name", race AS "Species", Class FROM "content" WHERE (college = "Lorehold") WHERE (role = "Faculty") -->
