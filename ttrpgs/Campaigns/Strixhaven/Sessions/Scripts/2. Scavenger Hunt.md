...
>[!tip] Each clue can be unraveled either by deduction, or with a successful DC 10 Intelligence (Investigation). A decoded clue points the characters toward one of the areas of the [[ttrpgs/Campaigns/Strixhaven/Locations/The Biblioplex]] as well as the action they must take to receive a prize in that area.
