...
type: magic item
attunement: Requires attunement by spellcaster
rarity: Uncommon
tags:
  - item
requires: 
...
The _Silverquill Primer_ is a magic textbook created at Strixhaven’s Silverquill College. The primer has 3 charges, and it regains 1d3 expended charges daily at dawn. If you make a Charisma ([[skills#Intimidation|Intimidation]]) or a Charisma ([[skills#Persuasion|Persuasion]]) check while holding the primer, you can expend 1 charge to give yourself a 1d4 bonus to the check, immediately after you roll the d20.
...
Notes: Bonus: Intimidation, Bonus: Persuasion, spellcaster