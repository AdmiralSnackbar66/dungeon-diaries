...
- What happens when the note link is clicked?
- Will it create a new note? 
- can you publish a list of notes for a certain tag without using dataview? 
More ideas
Syncing from iPad as well as from mobile phone (Android)