...
- "desc": "The dragon exhales a cloud of spores in a 15-foot cone. Each creature in\
    ...
    \ takes 5 (1d10) psychic damage, and it is [frightened](3-Mechanics/CLI/rules/conditions.md#Frightened)\
...
"source":
- "FTD"
"image": "3-Mechanics/CLI/bestiary/dragon/token/deep-dragon-wyrmling-ftd.webp"
```
^statblock