...
- "desc": "The dragon casts one of the following spells, requiring no material components\
    ...
    \ [calm emotions](3-Mechanics/CLI/spells/calm-emotions-xphb.md), [dispel magic](3-Mechanics/CLI/spells/dispel-magic-xphb.md),\
    \ [invisibility](3-Mechanics/CLI/spells/invisibility-xphb.md), [revivify](3-Mechanics/CLI/spells/revivify-xphb.md)"
  "name": "Spellcasting"
...
- "desc": "The dragon uses one of the following breath weapons:\n\n- Dream Breath.\
    ...
    \ on a DC 21 Constitution saving throw or fall [unconscious](3-Mechanics/CLI/rules/conditions.md#Unconscious)\
...
"source":
- "FTD"
"image": "3-Mechanics/CLI/bestiary/dragon/token/ancient-moonstone-dragon-ftd.webp"
```
^statblock