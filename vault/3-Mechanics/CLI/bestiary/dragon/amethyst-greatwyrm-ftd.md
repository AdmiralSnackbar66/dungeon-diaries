...
- "desc": "Melee Weapon Attack: +17 to hit, reach 10 ft., one target. Hit: 18\
    ...
    \ is [grappled](3-Mechanics/CLI/rules/conditions.md#Grappled) (escape DC 19) and\
    \ is [restrained](3-Mechanics/CLI/rules/conditions.md#Restrained) until this grapple\
    \ ends. The greatwyrm can have only one creature [grappled](3-Mechanics/CLI/rules/conditions.md#Grappled)\
...
- "desc": "The greatwyrm targets any number of creatures and objects it can see within\
    ...
    \ succeed on a DC 26 Strength saving throw or be [restrained](3-Mechanics/CLI/rules/conditions.md#Restrained)\
    ...
    \ itself. In addition, it can choose any number of creatures [restrained](3-Mechanics/CLI/rules/conditions.md#Restrained)\
...
"source":
- "FTD"
"image": "3-Mechanics/CLI/bestiary/dragon/token/amethyst-greatwyrm-ftd.webp"
```
^statblock