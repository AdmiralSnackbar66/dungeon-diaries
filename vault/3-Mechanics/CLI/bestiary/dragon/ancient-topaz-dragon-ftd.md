...
- "desc": "The dragon casts one of the following spells, requiring no spell components\
    ...
    \ each: [antilife shell](3-Mechanics/CLI/spells/antilife-shell-xphb.md), [bane](3-Mechanics/CLI/spells/bane-xphb.md),\
    \ [control water](3-Mechanics/CLI/spells/control-water-xphb.md), [create or destroy\
...
- "desc": "- Crystal Profusion. Natural stone within 6 miles of the lair grows\
    ...
    \ the [clairvoyance](3-Mechanics/CLI/spells/clairvoyance-xphb.md) spell, requiring\
...
"source":
- "FTD"
"image": "3-Mechanics/CLI/bestiary/dragon/token/ancient-topaz-dragon-ftd.webp"
```
^statblock