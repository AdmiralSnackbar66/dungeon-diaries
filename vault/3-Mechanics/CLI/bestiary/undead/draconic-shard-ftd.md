...
- "desc": "The shard casts one of the following spells, requiring no spell components\
    ...
    \ will: [detect thoughts](3-Mechanics/CLI/spells/detect-thoughts-xphb.md), [invisibility](3-Mechanics/CLI/spells/invisibility-xphb.md),\
...
- "desc": "When it drops to 0 hit points, the shard disappears and leaves a Tiny cracked\
    ...
    \ Unless the gemstone is destroyed, after d20 days, the gemstone dissipates\
...
- "desc": "The shard disappears as it pours its psychic essence into a Medium or smaller\
    ...
    \ an effect that ends possession, such as a [dispel evil and good](3-Mechanics/CLI/spells/dispel-evil-and-good-xphb.md)\
