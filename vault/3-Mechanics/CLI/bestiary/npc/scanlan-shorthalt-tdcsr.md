...
- "desc": "Scanlan is a 20th-level spellcaster. His spellcasting ability is Charisma\
    ...
    \ (4 slots): [healing word](3-Mechanics/CLI/spells/healing-word-xphb.md), [thunderwave](3-Mechanics/CLI/spells/thunderwave-xphb.md)\n\
    ...
    \ [counterspell](3-Mechanics/CLI/spells/counterspell-xphb.md), [lightning bolt](3-Mechanics/CLI/spells/lightning-bolt-xphb.md),\
    \ [stinking cloud](3-Mechanics/CLI/spells/stinking-cloud-xphb.md)\n\n4th level\
    \ (3 slots): [dimension door](3-Mechanics/CLI/spells/dimension-door-xphb.md),\
    \ [polymorph](3-Mechanics/CLI/spells/polymorph-xphb.md), [resilient sphere](3-Mechanics/CLI/spells/otilukes-resilient-sphere-xphb.md)\n\
    \n5th level (3 slots): [arcane hand](3-Mechanics/CLI/spells/bigbys-hand-xphb.md),\
    \ [dominate person](3-Mechanics/CLI/spells/dominate-person-xphb.md), [modify memory](3-Mechanics/CLI/spells/modify-memory-xphb.md),\
    \ [seeming](3-Mechanics/CLI/spells/seeming-xphb.md)\n\n6th level (2 slots):\
    \ [eyebite](3-Mechanics/CLI/spells/eyebite-xphb.md)\n\n7th level (2 slots):\
    \ [magnificent mansion](3-Mechanics/CLI/spells/mordenkainens-magnificent-mansion-xphb.md),\
    \ [reverse gravity](3-Mechanics/CLI/spells/reverse-gravity-xphb.md)\n\n8th level\
    \ (1 slots): [dominate monster](3-Mechanics/CLI/spells/dominate-monster-xphb.md)\n\
...
- "desc": "Scanlan has advantage on Intelligence, Wisdom, and Charisma saving throws\
    \ against magic."
  "name": "Gnome Cunning"
- "desc": "Scanlan has advantage on Constitution saving throws made to maintain [concentration](3-Mechanics/CLI/rules/conditions.md#Concentration)\
    \ on spells."
  "name": "Focused"
- "desc": "Scanlan wields [Mythcarver](3-Mechanics/CLI/items/mythcarver-exalted-tdcsr.md),\
    ...
    \ and carries a [hat of disguise](3-Mechanics/CLI/items/hat-of-disguise-xdmg.md)\
    \ and a [wand of magic missiles](3-Mechanics/CLI/items/wand-of-magic-missiles-xdmg.md)."
...
- "desc": "Melee Spell Attack: +11 to hit, reach 5 ft., one target. Hit: 45\
    ...
    \ on the [arcane hand](3-Mechanics/CLI/spells/bigbys-hand-xphb.md) spell."
...
- "desc": "Scanlan casts [healing word](3-Mechanics/CLI/spells/healing-word-xphb.md),\
    \ restoring 18 (5d4 + 6) hit points to himself or another creature he can see\
    \ within 60 feet of him."
  "name": "[Healing Word](3-Mechanics/CLI/spells/healing-word-xphb.md) (5th Level)"
"reactions":
