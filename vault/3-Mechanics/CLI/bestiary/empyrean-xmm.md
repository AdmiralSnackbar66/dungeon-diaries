...
- "desc": "Melee Attack Roll: +17, reach 10 ft. Hit: 31 (6d6 + 10) Force damage,\
    ...
    \ [Stunned](/3-Mechanics/CLI/conditions.md#Stunned), in which case it takes an\
    \ extra 21 Force damage that bypasses [Resistance](/3-Mechanics/CLI/variant-rules/resistance-xphb.md)\
    \ or [Immunity](/3-Mechanics/CLI/variant-rules/immunity-xphb.md)."
  "name": "Sacred Weapon"
- "desc": "Ranged Attack Roll: +15, range 600 ft. Hit: 35 (6d8 + 8) Necrotic or\
    \ Radiant damage (empyrean's choice)."
  "name": "Divine Ray"
"legendary_actions":
- "desc": "The empyrean gains 10 [Temporary Hit Points](/3-Mechanics/CLI/variant-rules/temporary-hit-points-xphb.md),\
    ...
    \ on [D20 Tests](/3-Mechanics/CLI/variant-rules/d20-test-xphb.md) until the end\
