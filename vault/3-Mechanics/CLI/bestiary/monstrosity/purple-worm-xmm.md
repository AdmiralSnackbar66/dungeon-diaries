...
*Source: Monster Manual (2024) p. 250. Available in the <span title='Systems Reference Document (5.2)'>SRD</span>*  
...
- "desc": "Strength Saving Throw: DC 19, one Large or smaller creature [Grappled](/3-Mechanics/CLI/conditions.md#Grappled)\
    ...
    \ and other effects outside the worm, and takes 17 (5d6) Acid damage at the start\
    ...
    \ each of which falls in a space within 5 feet of the worm and has the [Prone](/3-Mechanics/CLI/conditions.md#Prone)\
    \ condition. If the worm dies, any swallowed creature no longer has the [Restrained](/3-Mechanics/CLI/conditions.md#Restrained)\
