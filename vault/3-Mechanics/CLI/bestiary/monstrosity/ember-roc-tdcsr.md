...
The Fire Ashari of Pyrah believe that the mythic [rocs](roc-xmm.md) that gave rise to the ember rocs maintain balance in Tal'Dorei. [Rocs](roc-xmm.md) avoid humanoid settlements and hunt the monstrous creatures that would otherwise threaten those settlements. So "the Ashari" lure [rocs](roc-xmm.md) to sites of elemental rifts, enticing them to devour creatures attempting to escape into the Material Plane. After years of feeding on [fire elementals](fire-elemental-xmm.md), [salamanders](salamander-xmm.md), [fire giants](fire-giant-xmm.md), and more, a [roc](roc-xmm.md) is imbued with primordial power, flames erupting from every feather to transform it into the ember roc.

## Hopeless Ends

An ember roc patiently observes prey for hours before it strikes, snatching up [elephants](elephant-xmm.md), [whales](killer-whale-xmm.md), and even young dragons. It unleashes iron talons to <span title="Player's Handbook">grapple</span> targets, paying no heed to counter-attacks, then soars back to its nest—often inside an active volcano. If prey proves too much trouble while in flight, an ember roc readily drops it from some great height. But those unable to escape slowly roast in the creature's fiery grip.
