...
*Source: Monster Manual (2024) p. 34. Available in the <span title='Systems Reference Document (5.2)'>SRD</span>*  
...
- "desc": "The behir makes one Bite attack and uses Constrict."
  "name": "Multiattack"
- "desc": "Melee Attack Roll: +10, reach 10 ft. Hit: 19 (2d12 + 6) Piercing damage\
...
- "desc": "Dexterity Saving Throw: DC 18, one Large or smaller creature [Grappled](/3-Mechanics/CLI/conditions.md#Grappled)\
    ...
    \ and other effects outside the behir, and takes 21 (6d6) Acid damage at the start\
    ...
    \ in a space within 10 feet of the behir and has the [Prone](/3-Mechanics/CLI/conditions.md#Prone)\
