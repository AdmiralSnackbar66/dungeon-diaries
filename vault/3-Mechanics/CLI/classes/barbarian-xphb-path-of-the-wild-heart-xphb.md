...
When you activate your Rage, you can take the [Disengage](/3-Mechanics/CLI/actions.md#Disengage) and [Dash](/3-Mechanics/CLI/actions.md#Dash) actions as part of that [Bonus Action](/3-Mechanics/CLI/variant-rules/bonus-action-xphb.md). While your Rage is active, you can take a [Bonus Action](/3-Mechanics/CLI/variant-rules/bonus-action-xphb.md) to take both of those actions.

#### Wolf

While your Rage is active, your allies have [Advantage](/3-Mechanics/CLI/variant-rules/advantage-xphb.md) on attack rolls against any enemy of yours within 5 feet of you.

### Aspect of the Wilds (Level 6)

You gain one of the following options of your choice. Whenever you finish a [Long Rest](/3-Mechanics/CLI/variant-rules/long-rest-xphb.md), you can change your choice.
...
You have a [Climb Speed](/3-Mechanics/CLI/variant-rules/climb-speed-xphb.md) equal to your [Speed](/3-Mechanics/CLI/variant-rules/speed-xphb.md).

#### Salmon

You have a [Swim Speed](/3-Mechanics/CLI/variant-rules/swim-speed-xphb.md) equal to your [Speed](/3-Mechanics/CLI/variant-rules/speed-xphb.md).

### Nature Speaker (Level 10)

You can cast the [Commune with Nature](/3-Mechanics/CLI/spells/commune-with-nature-xphb.md) spell but only as a [Ritual](/3-Mechanics/CLI/variant-rules/ritual-xphb.md). Wisdom is your spellcasting ability for it.
...
While your Rage is active, you have a [Fly Speed](/3-Mechanics/CLI/variant-rules/fly-speed-xphb.md) equal to your [Speed](/3-Mechanics/CLI/variant-rules/speed-xphb.md) if you aren't wearing any armor.

#### Lion

While your Rage is active, any of your enemies within 5 feet of you have [Disadvantage](/3-Mechanics/CLI/variant-rules/disadvantage-xphb.md) on attack rolls against targets other than you or another Barbarian who has this option active.
