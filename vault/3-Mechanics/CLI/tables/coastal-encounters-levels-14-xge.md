...
| 11 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [poisonous snakes](/3-Mechanics/CLI/bestiary/beast/venomous-snake-xmm.md) |
| 12-13 | `dice:1d6\|noform\|noparens\|avg` (`1d6`) [guards](/3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md) protecting a standard [noble](/3-Mechanics/CLI/bestiary/humanoid/noble-xmm.md) |
...
| 21-25 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [ghouls](/3-Mechanics/CLI/bestiary/undead/ghoul-xmm.md) feeding on corpses aboard the wreckage of a merchant ship. A search uncovers `dice:2d6\|noform\|noparens\|avg` (`2d6`) bolts of ruined silk, a 50-foot length of rope. and a barrel of salted herring. |
| 26-27 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [winged kobolds](/3-Mechanics/CLI/bestiary/dragon/winged-kobold-xmm.md) with `dice:1d6+1\|noform\|noparens\|avg` (`1d6 + 1`) [kobolds](/3-Mechanics/CLI/bestiary/dragon/kobold-warrior-xmm.md) |
...
| 71-75 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [harpies](/3-Mechanics/CLI/bestiary/monstrosity/harpy-xmm.md) |
...
| 81 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [berserkers](/3-Mechanics/CLI/bestiary/humanoid/berserker-xmm.md) |
| 82 | `dice:1d6\|noform\|noparens\|avg` (`1d6`) [giant eagles](/3-Mechanics/CLI/bestiary/celestial/giant-eagle-xmm.md) |
| 83 | `dice:2d4\|noform\|noparens\|avg` (`2d4`) [giant toads](/3-Mechanics/CLI/bestiary/beast/giant-toad-xmm.md) |
| 84 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [ogres](/3-Mechanics/CLI/bestiary/giant/ogre-xmm.md) or `dice:1d4\|noform\|noparens\|avg` (`1d4`) [merrow](/3-Mechanics/CLI/bestiary/monstrosity/merrow-xmm.md) |
| 85 | `dice:3d6\|noform\|noparens\|avg` (`3d6`) [sahuagin](/3-Mechanics/CLI/bestiary/fiend/sahuagin-warrior-xmm.md) |
| 86 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [veterans](/3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md) |
| 87 | `dice:1d2\|noform\|noparens\|avg` (`1d2`) [plesiosauruses](/3-Mechanics/CLI/bestiary/beast/plesiosaurus-xmm.md) |
...
| 89 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [manticores](/3-Mechanics/CLI/bestiary/monstrosity/manticore-xmm.md) |
...
| 93-94 | 1 [sahuagin priestess](/3-Mechanics/CLI/bestiary/fiend/sahuagin-priest-xmm.md) with `dice:1d3\|noform\|noparens\|avg` (`1d3`) [merrow](/3-Mechanics/CLI/bestiary/monstrosity/merrow-xmm.md) and `dice:2d6\|noform\|noparens\|avg` (`2d6`) [sahuagin](/3-Mechanics/CLI/bestiary/fiend/sahuagin-warrior-xmm.md) |
