...
| 13-14 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [quaggoth thonots](/3-Mechanics/CLI/bestiary/monstrosity/quaggoth-thonot-xmm.md) with `dice:1d10+2\|noform\|noparens\|avg` (`1d10 + 2`) quaggoths |
| 15-16 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [ropers](/3-Mechanics/CLI/bestiary/aberration/roper-xmm.md) |
| 17-18 | `dice:3d6\|noform\|noparens\|avg` (`3d6`) [gargoyles](/3-Mechanics/CLI/bestiary/elemental/gargoyle-xmm.md) |
| 19-20 | `dice:1d10\|noform\|noparens\|avg` (`1d10`) [mimics](/3-Mechanics/CLI/bestiary/monstrosity/mimic-xmm.md) |
...
| 34-35 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [orc Eyes of Gruumsh](/3-Mechanics/CLI/bestiary/humanoid/cultist-fanatic-xmm.md) with `dice:2d4\|noform\|noparens\|avg` (`2d4`) [orogs](/3-Mechanics/CLI/bestiary/humanoid/berserker-xmm.md) and `dice:2d10\|noform\|noparens\|avg` (`2d10`) [orcs](/3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md) |
...
| 59 | `dice:1d10\|noform\|noparens\|avg` (`1d10`) [ghosts](/3-Mechanics/CLI/bestiary/undead/ghost-xmm.md) |
...
| 66 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [chimeras](/3-Mechanics/CLI/bestiary/monstrosity/chimera-xmm.md) |
| 67 | `dice:1d10\|noform\|noparens\|avg` (`1d10`) [black puddings](/3-Mechanics/CLI/bestiary/ooze/black-pudding-xmm.md) |
...
| 74 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [grick alphas](/3-Mechanics/CLI/bestiary/aberration/grick-ancient-xmm.md) |
| 75 | `dice:1d6+2\|noform\|noparens\|avg` (`1d6 + 2`) [xorn](/3-Mechanics/CLI/bestiary/elemental/xorn-xmm.md) |
| 76-80 | A ruined village that once belonged to deep gnomes. A search has a 50% chance of uncovering `dice:1d3\|noform\|noparens\|avg` (`1d3`) [potions of healing](/3-Mechanics/CLI/items/potion-of-healing-xdmg.md) and a 25% chance of finding a random common magic item |
| 81 | `dice:2d4\|noform\|noparens\|avg` (`2d4`) [earth elementals](/3-Mechanics/CLI/bestiary/elemental/earth-elemental-xmm.md) |
| 82 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [spirit nagas](/3-Mechanics/CLI/bestiary/fiend/spirit-naga-xmm.md) |
...
| 87 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [fomorians](/3-Mechanics/CLI/bestiary/giant/fomorian-xmm.md) |
| 88 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [drow mages](/3-Mechanics/CLI/bestiary/humanoid/bandit-deceiver-xmm.md) with `dice:1d4\|noform\|noparens\|avg` (`1d4`) [drow elite warriors](/3-Mechanics/CLI/bestiary/humanoid/gladiator-xmm.md) |
| 89 | `dice:1d10\|noform\|noparens\|avg` (`1d10`) [vampire spawn](/3-Mechanics/CLI/bestiary/undead/vampire-spawn-xmm.md) |
| 90 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [cloakers](/3-Mechanics/CLI/bestiary/aberration/cloaker-xmm.md) |
| 91 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [fire giants](/3-Mechanics/CLI/bestiary/giant/fire-giant-xmm.md) |
...
| 93 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [dao](/3-Mechanics/CLI/bestiary/elemental/dao-xmm.md) |
| 94 | `dice:1d8+1\|noform\|noparens\|avg` (`1d8 + 1`) [driders](/3-Mechanics/CLI/bestiary/monstrosity/drider-xmm.md) |
| 95 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [behirs](/3-Mechanics/CLI/bestiary/monstrosity/behir-xmm.md) |
| 96 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [aboleths](/3-Mechanics/CLI/bestiary/aberration/aboleth-xmm.md) |
