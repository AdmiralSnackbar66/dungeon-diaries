...
| 03 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [giant lizards](/3-Mechanics/CLI/bestiary/beast/giant-lizard-xmm.md) |
...
| 07 | `dice:1d12\|noform\|noparens\|avg` (`1d12`) [giant rats](/3-Mechanics/CLI/bestiary/beast/giant-rat-xmm.md) |
...
| 11-12 | `dice:1d10\|noform\|noparens\|avg` (`1d10`) [troglodytes](/3-Mechanics/CLI/bestiary/monstrosity/troglodyte-xmm.md) |
| 13-14 | `dice:1d2\|noform\|noparens\|avg` (`1d2`) [gray oozes](/3-Mechanics/CLI/bestiary/ooze/gray-ooze-xmm.md) |
| 15-16 | `dice:3d6\|noform\|noparens\|avg` (`3d6`) [stirges](/3-Mechanics/CLI/bestiary/monstrosity/stirge-xmm.md) |
| 17-18 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [magma mephits](/3-Mechanics/CLI/bestiary/elemental/magma-mephit-xmm.md) |
| 19-20 | `dice:1d10\|noform\|noparens\|avg` (`1d10`) [goblins](/3-Mechanics/CLI/bestiary/fey/goblin-warrior-xmm.md) |
...
| 29-30 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [violet fungi](/3-Mechanics/CLI/bestiary/plant/violet-fungus-xmm.md) |
| 31-32 | `dice:1d12\|noform\|noparens\|avg` (`1d12`) [kuo-toa](/3-Mechanics/CLI/bestiary/aberration/kuo-toa-xmm.md) |
...
| 46 | `dice:1d8\|noform\|noparens\|avg` (`1d8`) [darkmantles](/3-Mechanics/CLI/bestiary/aberration/darkmantle-xmm.md) or `dice:2d4\|noform\|noparens\|avg` (`2d4`) [piercers](/3-Mechanics/CLI/bestiary/aberration/piercer-xmm.md) |
| 47 | 1 [hell hound](/3-Mechanics/CLI/bestiary/fiend/hell-hound-xmm.md) |
| 48 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [specters](/3-Mechanics/CLI/bestiary/undead/specter-xmm.md) |
| 49 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [bugbears](/3-Mechanics/CLI/bestiary/fey/bugbear-warrior-xmm.md) |
| 50 | `dice:1d10+5\|noform\|noparens\|avg` (`1d10 + 5`) [winged kobolds](/3-Mechanics/CLI/bestiary/dragon/winged-kobold-xmm.md) |
| 51 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [fire snakes](/3-Mechanics/CLI/bestiary/elemental/salamander-fire-snake-xmm.md) |
| 52 | `dice:2d8+1\|noform\|noparens\|avg` (`2d8 + 1`) [troglodytes](/3-Mechanics/CLI/bestiary/monstrosity/troglodyte-xmm.md) |
| 53 | `dice:1d6\|noform\|noparens\|avg` (`1d6`) [giant spiders](/3-Mechanics/CLI/bestiary/beast/giant-spider-xmm.md) |
...
| 60 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [myconid adults](/3-Mechanics/CLI/bestiary/plant/myconid-adult-xmm.md) with `dice:5d4\|noform\|noparens\|avg` (`5d4`) [myconid sprouts](/3-Mechanics/CLI/bestiary/plant/myconid-sprout-xmm.md) |
...
| 70 | `dice:1d12\|noform\|noparens\|avg` (`1d12`) [gas spores](/3-Mechanics/CLI/bestiary/plant/gas-spore-fungus-xmm.md) |
| 71 | 1 [giant constrictor snake](/3-Mechanics/CLI/bestiary/beast/giant-constrictor-snake-xmm.md) |
| 72 | `dice:1d10\|noform\|noparens\|avg` (`1d10`) [shadows](/3-Mechanics/CLI/bestiary/undead/shadow-xmm.md) |
| 73 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [grells](/3-Mechanics/CLI/bestiary/aberration/grell-xmm.md) |
| 74 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [wights](/3-Mechanics/CLI/bestiary/undead/wight-xmm.md) |
...
| 76 | `dice:1d2\|noform\|noparens\|avg` (`1d2`) [gargoyles](/3-Mechanics/CLI/bestiary/elemental/gargoyle-xmm.md) |
| 77 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [ogres](/3-Mechanics/CLI/bestiary/giant/ogre-xmm.md) or `dice:1d3\|noform\|noparens\|avg` (`1d3`) [ettins](/3-Mechanics/CLI/bestiary/giant/ettin-xmm.md) |
| 78 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) dwarf explorers ([veterans](/3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md)) |
| 79-80 | An abandoned miners' camp spattered with blood and littered with the contents of `dice:1d3\|noform\|noparens\|avg` (`1d3`) [dungeoneer's packs](/3-Mechanics/CLI/items/dungeoneers-pack-xphb.md) |
...
| 82 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [phase spiders](/3-Mechanics/CLI/bestiary/monstrosity/phase-spider-xmm.md) or `dice:1d3\|noform\|noparens\|avg` (`1d3`) [hook horrors](/3-Mechanics/CLI/bestiary/monstrosity/hook-horror-xmm.md) |
...
| 86 | 1 [hobgoblin captain](/3-Mechanics/CLI/bestiary/fey/hobgoblin-captain-xmm.md) with `dice:1d4\|noform\|noparens\|avg` (`1d4`) [half-ogres](/3-Mechanics/CLI/bestiary/giant/ogrillon-ogre-xmm.md) and `dice:2d10\|noform\|noparens\|avg` (`2d10`) [hobgoblins](/3-Mechanics/CLI/bestiary/fey/hobgoblin-warrior-xmm.md) |
...
| 89 | 1 [quaggoth thonot](/3-Mechanics/CLI/bestiary/monstrosity/quaggoth-thonot-xmm.md) with `dice:1d3\|noform\|noparens\|avg` (`1d3`) [quaggoths](/3-Mechanics/CLI/bestiary/monstrosity/quaggoth-xmm.md) |
...
| 91 | 1 [orc Eye of Gruumsh](/3-Mechanics/CLI/bestiary/humanoid/cultist-fanatic-xmm.md) with `dice:1d4\|noform\|noparens\|avg` (`1d4`) [orogs](/3-Mechanics/CLI/bestiary/humanoid/berserker-xmm.md) and `dice:2d8\|noform\|noparens\|avg` (`2d8`) [orcs](/3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md) |
| 92 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [ghasts](/3-Mechanics/CLI/bestiary/undead/ghast-xmm.md) with `dice:1d10\|noform\|noparens\|avg` (`1d10`) [ghouls](/3-Mechanics/CLI/bestiary/undead/ghoul-xmm.md) |
