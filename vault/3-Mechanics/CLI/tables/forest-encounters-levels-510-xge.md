...
| 04 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [will-o'-wisps](/3-Mechanics/CLI/bestiary/undead/will-o-wisp-xmm.md) |
| 05 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [swarms of poisonous snakes](/3-Mechanics/CLI/bestiary/beast/swarm-of-venomous-snakes-xmm.md) |
| 06 | 1 [orc Eye of Gruumsh](/3-Mechanics/CLI/bestiary/humanoid/cultist-fanatic-xmm.md) with `dice:1d3\|noform\|noparens\|avg` (`1d3`) [orogs](/3-Mechanics/CLI/bestiary/humanoid/berserker-xmm.md) and `dice:1d8+2\|noform\|noparens\|avg` (`1d8 + 2`) [orcs](/3-Mechanics/CLI/bestiary/humanoid/tough-xmm.md) |
| 07 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [constrictor snakes](/3-Mechanics/CLI/bestiary/beast/constrictor-snake-xmm.md) or `dice:1d4\|noform\|noparens\|avg` (`1d4`) [tigers](/3-Mechanics/CLI/bestiary/beast/tiger-xmm.md) |
...
| 11-13 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [giant boars](/3-Mechanics/CLI/bestiary/beast/giant-boar-xmm.md) |
...
| 18 | `dice:1d10\|noform\|noparens\|avg` (`1d10`) [giant toads](/3-Mechanics/CLI/bestiary/beast/giant-toad-xmm.md) |
| 19 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [ankhegs](/3-Mechanics/CLI/bestiary/monstrosity/ankheg-xmm.md) |
| 20 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [awakened trees](/3-Mechanics/CLI/bestiary/plant/awakened-tree-xmm.md) (day) or 1 [banshee](/3-Mechanics/CLI/bestiary/undead/banshee-xmm.md) (night) |
...
| 27-28 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [ogres](/3-Mechanics/CLI/bestiary/giant/ogre-xmm.md) or `dice:1d6+2\|noform\|noparens\|avg` (`1d6 + 2`) [half-ogres](/3-Mechanics/CLI/bestiary/giant/ogrillon-ogre-xmm.md) |
...
| 31-32 | `dice:1d6\|noform\|noparens\|avg` (`1d6`) [wererats](/3-Mechanics/CLI/bestiary/monstrosity/wererat-xmm.md) |
| 33 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [gricks](/3-Mechanics/CLI/bestiary/aberration/grick-xmm.md) |
...
| 35 | `dice:1d6\|noform\|noparens\|avg` (`1d6`) [pegasi](/3-Mechanics/CLI/bestiary/celestial/pegasus-xmm.md) |
...
| 43 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [giant elk](/3-Mechanics/CLI/bestiary/celestial/giant-elk-xmm.md) |
...
| 55-56 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [owlbears](/3-Mechanics/CLI/bestiary/monstrosity/owlbear-xmm.md) |
| 57-58 | `dice:1d8+1\|noform\|noparens\|avg` (`1d8 + 1`) [berserkers](/3-Mechanics/CLI/bestiary/humanoid/berserker-xmm.md) |
| 59-60 | `dice:1d3\|noform\|noparens\|avg` (`1d3`) [green hags](/3-Mechanics/CLI/bestiary/fey/green-hag-xmm.md) |
| 61-65 | A clear pool of water with `dice:1d6\|noform\|noparens\|avg` (`1d6`) sleeping animals lying around its edge |
| 66-67 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [werewolves](/3-Mechanics/CLI/bestiary/monstrosity/werewolf-xmm.md) |
...
| 74-75 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [veterans](/3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md) |
| 76-80 | An old tree with a wizened face carved into the trunk |
| 81 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [wereboars](/3-Mechanics/CLI/bestiary/monstrosity/wereboar-xmm.md) |
| 82 | `dice:2d4\|noform\|noparens\|avg` (`2d4`) [displacer beasts](/3-Mechanics/CLI/bestiary/monstrosity/displacer-beast-xmm.md) |
| 83 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [shambling mounds](/3-Mechanics/CLI/bestiary/plant/shambling-mound-xmm.md) |
...
| 87 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [trolls](/3-Mechanics/CLI/bestiary/giant/troll-xmm.md) |
...
| 90 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [unicorns](/3-Mechanics/CLI/bestiary/celestial/unicorn-xmm.md) |
...
| 93 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [gorgons](/3-Mechanics/CLI/bestiary/construct/gorgon-xmm.md) |
...
| 96 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [revenants](/3-Mechanics/CLI/bestiary/undead/revenant-xmm.md) |
...
| 98 | `dice:1d4\|noform\|noparens\|avg` (`1d4`) [giant apes](/3-Mechanics/CLI/bestiary/beast/giant-ape-xmm.md) |
