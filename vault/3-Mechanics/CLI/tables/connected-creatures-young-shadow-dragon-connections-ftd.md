...
| 4 | A young shadow dragon shares a lair with a [cloaker](cloaker-xmm.md); the cloaker leaves the dragon alone but hunts other creatures in the lair. |
| 5 | A young shadow dragon is attended by the [shadows](shadow-xmm.md) formed from the dragon's breath, even though the dragon despises these Undead. |
