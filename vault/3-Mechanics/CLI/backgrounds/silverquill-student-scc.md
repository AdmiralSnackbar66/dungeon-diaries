...
- **Skill Proficiencies.** [Intimidation](/3-Mechanics/CLI/skills.md#Intimidation), [Persuasion](/3-Mechanics/CLI/skills.md#Persuasion)  
- **Languages.** Two of your choice  
- **Equipment.** A [bottle of black ink](/3-Mechanics/CLI/items/ink-xphb.md), an [ink pen](/3-Mechanics/CLI/items/ink-pen-xphb.md), a book of poetry, a school uniform, and a [pouch](/3-Mechanics/CLI/items/pouch-xphb.md) containing 15 gp  
...
| Spell Level | Spells |
|-------------|--------|
| 1st | [Dissonant Whispers](/3-Mechanics/CLI/spells/dissonant-whispers-xphb.md), [Silvery Barbs](/3-Mechanics/CLI/spells/silvery-barbs-scc.md) |
| 2nd | [Calm Emotions](/3-Mechanics/CLI/spells/calm-emotions-xphb.md), [Darkness](/3-Mechanics/CLI/spells/darkness-xphb.md) |
| 3rd | [Beacon of Hope](/3-Mechanics/CLI/spells/beacon-of-hope-xphb.md), [Daylight](/3-Mechanics/CLI/spells/daylight-xphb.md) |
| 4th | [Compulsion](/3-Mechanics/CLI/spells/compulsion-xphb.md), [Confusion](/3-Mechanics/CLI/spells/confusion-xphb.md) |
| 5th | [Dominate Person](/3-Mechanics/CLI/spells/dominate-person-xphb.md), [Rary's Telepathic Bond](/3-Mechanics/CLI/spells/rarys-telepathic-bond-xphb.md) |
^silverquill-spells
...
Many bards find a home in Silverquill, putting the power of their voices to use with Silverquill magic. Wizards (especially those who study the Schools of [Illusion](/3-Mechanics/CLI/classes/wizard-xphb-illusionist-xphb.md) and Enchantment) are common in Silverquill, as are warlocks. Clerics with the Divine Domains of [Light](/3-Mechanics/CLI/classes/cleric-xphb-light-domain-xphb.md) and [Trickery](/3-Mechanics/CLI/classes/cleric-xphb-trickery-domain-xphb.md) also fit in well among the mages of Silverquill.
...
When you make your character, you may roll once on the [Silverquill Trinkets](/3-Mechanics/CLI/items/silverquill-trinket-scc.md) table, instead of on the [Trinkets table](/3-Mechanics/CLI/items/trinket-xphb.md) in the "Player's Handbook", for your starting trinket.