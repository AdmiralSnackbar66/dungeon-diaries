...
- **Properties**: [Versatile](3-Mechanics/CLI/rules/item-properties.md#Versatile), [Vestige of Divergence](3-Mechanics/CLI/rules/item-properties.md#Vestige%20of%20Divergence)
- **Weight**: 3.0 lbs.
...
The thick, grooved blade of this shining silver [longsword](3-Mechanics/CLI/items/longsword-xphb.md) is lined with etched runes that sparkle blue in the light. Star Razor—known also as Dwueth'var—was thought to have been destroyed or lost after the "Calamity", but new rumors suggest that it might be wielded by a half-orc somewhere in "Wildemount".
...
- You can cast the [faerie fire](3-Mechanics/CLI/spells/faerie-fire-xphb.md) spell from the weapon as an action, requiring no components (save DC 13). Once a spell has been cast using Star Razor, that spell can't be cast from the sword until the next dawn.  
...
- You can cast the [see invisibility](3-Mechanics/CLI/spells/see-invisibility-xphb.md) spell from the sword as an action, and the save DC for spells cast using the sword increases to 15.  
...
- You can cast the [fly](3-Mechanics/CLI/spells/fly-xphb.md) spell from the sword as an action, and the save DC for spells cast using the sword increases to 17.  
