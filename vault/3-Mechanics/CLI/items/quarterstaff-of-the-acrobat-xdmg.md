...
While holding this weapon, you have [Advantage](/3-Mechanics/CLI/variant-rules/advantage-xphb.md) on Dexterity ([Acrobatics](/3-Mechanics/CLI/skills.md#Acrobatics)) checks.
