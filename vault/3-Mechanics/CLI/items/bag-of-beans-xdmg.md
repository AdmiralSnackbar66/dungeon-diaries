...
| 02-10 | A geyser erupts and spouts water, beer, mayonnaise, tea, vinegar, wine, or oil (DM's choice) 30 feet into the air for `dice:1d4\|noform\|noparens\|avg` (`1d4`) minutes. |
...
| 71-80 | A fruit tree grows. It has `dice:1d10+20\|noform\|noparens\|avg` (`1d10 + 20`) fruit, `dice:1d8\|noform\|noparens\|avg` (`1d8`) of which act as randomly determined potions. The tree vanishes after 1 hour. Picked fruit remains, retaining any magic for 30 days. |
...
*Source: Dungeon Master's Guide (2024) p. 233. Available in the <span title='Systems Reference Document (5.2)'>SRD</span>*