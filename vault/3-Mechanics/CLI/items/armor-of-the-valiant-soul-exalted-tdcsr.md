...
While the Armor of the Valiant Soul is in a dormant state, you gain a +1 bonus to AC while wearing it. You can also cast the [command](3-Mechanics/CLI/spells/command-xphb.md) spell (save DC 14) while attuned to this armor. Once this property is used, it can't be used again until you finish a long rest.
...
- The spell save DC for the armor's [command](3-Mechanics/CLI/spells/command-xphb.md) spell increases to 16, and the spell can target up to three creatures.  
...
- The spell save DC of the armor's [command](3-Mechanics/CLI/spells/command-xphb.md) spell increases to 18, and the spell can target up to five creatures.  
