...
- **Properties**: [Heavy](3-Mechanics/CLI/rules/item-properties.md#Heavy), [Two-Handed](3-Mechanics/CLI/rules/item-properties.md#Two-Handed), [Vestige of Divergence](3-Mechanics/CLI/rules/item-properties.md#Vestige%20of%20Divergence)
- **Weight**: 10.0 lbs.
...
- As an action, you can slam Pyremaul into the ground to cast the [burning hands](3-Mechanics/CLI/spells/burning-hands-xphb.md) spell at 2nd level (save DC 15). You can't use this property again until you finish a short or long rest.  
...
- When you cast [burning hands](3-Mechanics/CLI/spells/burning-hands-xphb.md) with the weapon, you do so at 3rd level and the save DC increases to 17.  
