...
![The arrival of a mind flay...](/3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/060-04-001-nautiloid.webp#center "The arrival of a mind flayer nautiloid means trouble for any world—and adventure for that world's heroes!")
...
![Fortresses on the backs of...](/3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/064-04-005-dragon-turtle-fortress.webp#center "Fortresses on the backs of dragon turtles rise from the depths, heralding the return of a long-lost dynasty")
...
- **School of Necromancy.** [Vampires](/3-Mechanics/CLI/bestiary/undead/vampire-xmm.md) open a college of necromancy, attracting evil necromancers who need fresh corpses for their studies. An order of vampire hunters seeks the characters' help.  
- **Undying Monarch.** A venerable monarch clings to power by worshiping "Orcus" and becoming a [lich](/3-Mechanics/CLI/bestiary/undead/lich-xmm.md).  
...
![The bold adventurer Murlyn...](/3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/065-04-006-murlynd.webp#center "The bold adventurer Murlynd has visited many worlds and has a fondness for six-shooters and talking clocks")
...
- **The Waking Deep.** A monstrous horror slumbering in the depths of the ocean stirs, driving minions such as sahuagin, [merrows](/3-Mechanics/CLI/bestiary/monstrosity/merrow-xmm.md), or [dragon turtles](/3-Mechanics/CLI/bestiary/dragon/dragon-turtle-xmm.md) to attack seafaring vessels.  
...
![Using a Published Setting; D&D Settings](/3-Mechanics/CLI/tables/using-a-published-setting-d-d-settings-xdmg.md)
...
- **How Common Is Magic?.** Spellcasters and magic item shops might be common, rare, or practically nonexistent in your world. How readily available are spells such as [Lesser Restoration](/3-Mechanics/CLI/spells/lesser-restoration-xphb.md), [Raise Dead](/3-Mechanics/CLI/spells/raise-dead-xphb.md), and [Teleportation Circle](/3-Mechanics/CLI/spells/teleportation-circle-xphb.md)? Is magic so widespread that it's part of daily life, or so rare that it conjures all sorts of superstitions?  
...
![A time of sorrow can bring...](/3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/066-04-007-time-of-sorrow.webp#center "A time of sorrow can bring people together and even launch an adventuring party")
...
![Linking Adventures; Adventure Connections](/3-Mechanics/CLI/tables/linking-adventures-adventure-connections-xdmg.md)
...
![In the Dragonlance setting...](/3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/067-04-008-dragonlance-inn.webp#center "In the Dragonlance setting, Tanis and Tika call their local inn home: a place to see familiar faces like Fizban the Fabulous")
...
![Tiamat herself brings a ca...](/3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/068-05-002-tiamat-encounter.webp#center "Tiamat herself brings a campaign to a dramatic close")
...
![Months and Festivals; Days of the Week](/3-Mechanics/CLI/tables/months-and-festivals-days-of-the-week-xdmg.md)
...
![Gods of Greyhawk](/3-Mechanics/CLI/tables/gods-of-greyhawk-xdmg.md)
...
![White Plume Mountain is a ...](/3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/072-05-004-white-plume-mountain.webp#center "White Plume Mountain is a natural wonder—and a haunt of evil")
...
![The Free City of Greyhawk ...](/3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/073-05-005-city-of-greyhawk.webp#center "The Free City of Greyhawk rises up behind the teeming city docks")
...
The Free City of Greyhawk is ruled by a council called the Directing Oligarchy, made up of sixteen coequal rulers. This council elects its chief officer, the lord mayor—a position currently held by a human [Spy Master](/3-Mechanics/CLI/bestiary/humanoid/spy-master-xmm.md) (Lawful Neutral) named Nerof Gasgol. The other directors include the captain-general and constable of the City Watch, several guild masters, priests of Boccob and Rao, the inspector of taxes, and a few influential magic-users with ties to politically active secret societies. Several of these directors represent criminal or unsavory interests, including Nerof Gasgol himself, who achieved his position and wealth as the owner of a notorious gambling den.

##### City Watch

The City Watch is a standing garrison of some eight hundred [Guards](/3-Mechanics/CLI/bestiary/humanoid/guard-xmm.md) and [Veteran Warriors](/3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md). Bolstering these defenders are [Mages](/3-Mechanics/CLI/bestiary/humanoid/mage-xmm.md) from the city's Guild of Wizardry, as well as [Priests](/3-Mechanics/CLI/bestiary/humanoid/priest-xmm.md) from local temples.
...
The category of minor crimes includes armed assault (defined as any nonfatal attack made with a weapon or damaging spell) and property crimes that cause between 50 and 250 GP in damages. The perpetrator must pay a fine of at least 100 GP and is sentenced to `dice:1d6|noform|noparens|avg` (`1d6`) years in prison.
...
The city's constable—who serves as second-in-command to the captain-general, manager to the members of the watch, and a member of the Directing Oligarchy—is a compassionate [Priest](/3-Mechanics/CLI/bestiary/humanoid/priest-xmm.md) of Pelor named Derider Fanshen (Neutral Good). Her kindness and talent for healing make her well loved among the watch, and as a former adventurer, she is sympathetic to adventurers' needs. She's unaware of Sental's compromised position.

###### Character Backgrounds

Adventurers with the [Criminal](/3-Mechanics/CLI/backgrounds/criminal-xphb.md) or [Guard](/3-Mechanics/CLI/backgrounds/guard-xphb.md) background might have a connection to the Grand Citadel involving a past run-in with the law or past service on the watch.
...
Adventurers with the [Merchant](/3-Mechanics/CLI/backgrounds/merchant-xphb.md) or [Noble](/3-Mechanics/CLI/backgrounds/noble-xphb.md) background might have a connection to the High Tower Inn, which caters to people of means.
...
![The Silver Dragon Inn is a...](/3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/074-05-006-silver-dragon-inn.webp#center "The Silver Dragon Inn is a lively hub of activity in Greyhawk's Foreign Quarter")
...
Weapons larger than daggers must be checked at the door, together with shields. Customers wearing metal armor aren't admitted. Two bouncers (Neutral [Tough Bosses](/3-Mechanics/CLI/bestiary/humanoid/tough-boss-xmm.md)) stand at the door, politely enforcing the rule.

The inn's married human proprietors, Olaf Al-Azul (Chaotic Good [Warrior Veteran](/3-Mechanics/CLI/bestiary/humanoid/warrior-veteran-xmm.md)) and Sivan Al-Azul (Chaotic Neutral [Assassin](/3-Mechanics/CLI/bestiary/humanoid/assassin-xmm.md)), speak multiple languages and use humor to raise spirits and diffuse tensions. Olaf can almost always break up a fight before it starts, generally with a round of drinks for the instigators. Sivan is quiet and introspective, but he always keeps a hilarious joke or cutting remark at the ready.

###### Character Backgrounds

Adventurers with the [Artisan](/3-Mechanics/CLI/backgrounds/artisan-xphb.md) or [Entertainer](/3-Mechanics/CLI/backgrounds/entertainer-xphb.md) background might do business with the Silver Dragon Inn.
...
Situated in the Garden Quarter, this temple is dedicated to Fharlanghn, a god favored by travelers and mercenaries. The [Priests](/3-Mechanics/CLI/bestiary/humanoid/priest-xmm.md) who staff the temple offer nourishment, rest, and healing to those in need, day and night. Several small rooms are maintained for guests, and simple, hot meals are free to all visitors.

###### Character Backgrounds

Adventurers with the [Guide](/3-Mechanics/CLI/backgrounds/guide-xphb.md) or [Sailor](/3-Mechanics/CLI/backgrounds/sailor-xphb.md) background might have a connection to the temple, which offers help to travelers.
...
- **Healing.** Adventurers can purchase [Potions of Healing](/3-Mechanics/CLI/items/potion-of-healing-xdmg.md) for 50 GP each, and the temple's priests have `dice:1d4|noform|noparens|avg` (`1d4`) such potions in stock on any given day. The priests also have [Cure Wounds](/3-Mechanics/CLI/spells/cure-wounds-xphb.md) and [Lesser Restoration](/3-Mechanics/CLI/spells/lesser-restoration-xphb.md) spells prepared and customarily cast them for free. For more powerful magic, such as [Greater Restoration](/3-Mechanics/CLI/spells/greater-restoration-xphb.md) and [Raise Dead](/3-Mechanics/CLI/spells/raise-dead-xphb.md) spells, the priests direct the adventurers to the Temple of the Radiant Sun.  
...
- **Teleportation Circle.** Though it isn't the only permanent teleportation circle in the city, the circle within the Temple of the Far Horizon is the easiest to access. The priests allow free access to the teleportation circle in either direction. For 2,000 GP, the chief priest will cast the [Teleportation Circle](/3-Mechanics/CLI/spells/teleportation-circle-xphb.md) spell to open a connection to another permanent circle on the Material Plane.  
...
This temple, dedicated to serving the god Pelor in the heart of the Garden Quarter, opens at dawn and closes at dusk. In a sanctuary in the heart of the temple, [Priests](/3-Mechanics/CLI/bestiary/humanoid/priest-xmm.md) conduct daily morning rites, as well as all-day observances every Godsday.

Sarana, the temple's [Archpriest](/3-Mechanics/CLI/bestiary/humanoid/archpriest-xmm.md) (Neutral Good), is a middle-aged, human woman wearing a sun-shaped headdress and yellow-and-gold robes. She is never seen in public without her [Staff of Healing](/3-Mechanics/CLI/items/staff-of-healing-xdmg.md). Sarana has straw-colored hair, green eyes, and a forgiving nature.

###### Character Backgrounds

Adventurers with the [Acolyte](/3-Mechanics/CLI/backgrounds/acolyte-xphb.md) background might have served in the Temple of the Radiant Sun, while those with the Farmer background might seek it out as a place for blessing.

###### Reasons to Visit

Adventurers might visit the temple for one of the following reasons:

- **Healing.** The temple sells [Spell Scrolls](/3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [Greater Restoration](/3-Mechanics/CLI/spells/greater-restoration-xphb.md) for 3,200 GP apiece and [Spell Scrolls](/3-Mechanics/CLI/items/spell-scroll-xdmg.md) of [Remove Curse](/3-Mechanics/CLI/spells/remove-curse-xphb.md) for 300 GP apiece, and the priests have `dice:1d3|noform|noparens|avg` (`1d3`) copies of each scroll in stock on any given day. The priests also have [Cure Wounds](/3-Mechanics/CLI/spells/cure-wounds-xphb.md) and [Lesser Restoration](/3-Mechanics/CLI/spells/lesser-restoration-xphb.md) spells prepared, which they customarily cast for free.  
- **Raise Dead.** Archpriest Sarana is one of a handful of people in the Free City of Greyhawk who can cast the [Raise Dead](/3-Mechanics/CLI/spells/raise-dead-xphb.md) spell, but she needs the requisite 500 GP diamond to do so. Sarana can recommend a jeweler who sells diamonds of sufficient value. Before agreeing to cast the spell, Sarana casts [Zone of Truth](/3-Mechanics/CLI/spells/zone-of-truth-xphb.md) and asks questions about the deceased individual to make sure she's not returning to life someone who should stay dead.  
...
Adventurers with the [Charlatan](/3-Mechanics/CLI/backgrounds/charlatan-xphb.md) or [Hermit](/3-Mechanics/CLI/backgrounds/hermit-xphb.md) background might have a connection to Unearthed Arcana, as Morley has a variety of unusual interests.
...
- **Magic Item Identification.** Morley can cast the [Identify](/3-Mechanics/CLI/spells/identify-xphb.md) spell at will. He charges 50 GP for each casting of the spell.  
...
- **Mistmarsh.** This vast swamp holds the half-sunken ruins of an ancient city that is now shrouded by fog and guarded by a family of black dragons. [Will-o'-wisps](/3-Mechanics/CLI/bestiary/undead/will-o-wisp-xmm.md) lure prey to the ruins, where doom awaits.  
...
> - **Scholarly Expertise.** Characters who have proficiency in the [Arcana](/3-Mechanics/CLI/skills.md#Arcana), [History](/3-Mechanics/CLI/skills.md#History), or [Religion](/3-Mechanics/CLI/skills.md#Religion) skill can be fonts of useful information. When it would be helpful for a group to know something about the setting, ask such characters to make an Intelligence check using the relevant skill, then share plot-relevant details if their roll warrants it.  
> - **Magical Footnotes.** Spells such as [Contact Other Plane](/3-Mechanics/CLI/spells/contact-other-plane-xphb.md), [Legend Lore](/3-Mechanics/CLI/spells/legend-lore-xphb.md), and [Speak with Dead](/3-Mechanics/CLI/spells/speak-with-dead-xphb.md) allow characters to learn information while leaving you control of the particulars.  
...
![The Holy Days of Rao are o...](/3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/080-05-008-holy-days-of-rao.webp#center "The Holy Days of Rao are occasions for joyful processions and festivals in Veluna")
...
![Central Flanaess Locations](/3-Mechanics/CLI/tables/central-flanaess-locations-xdmg.md)
...
![Eastern Flanaess Locations](/3-Mechanics/CLI/tables/eastern-flanaess-locations-xdmg.md)
...
![The Tomb of Horrors lies d...](/3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/081-05-009-tomb-of-horrors.webp#center "The Tomb of Horrors lies deep within the vast swamp")
...
![Northern Flanaess Locations](/3-Mechanics/CLI/tables/northern-flanaess-locations-xdmg.md)
...
![Adventurers in the North K...](/3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/082-05-010-mammoth-north-kingdoms.webp#center "Adventurers in the North Kingdoms help a frost giant's pet mammoth find its way home")
...
![Old Keoland Locations](/3-Mechanics/CLI/tables/old-keoland-locations-xdmg.md)
...
![Beneath the beautiful surf...](/3-Mechanics/CLI/books/dungeon-masters-guide-2024/img/083-05-011-hellfurnaces.webp#center "Beneath the beautiful surface of the Hellfurnaces lie endless hidden evils")
...
![Western Flanaess Locations](/3-Mechanics/CLI/tables/western-flanaess-locations-xdmg.md)
