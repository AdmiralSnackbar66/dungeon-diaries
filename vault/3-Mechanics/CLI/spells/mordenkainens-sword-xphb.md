...
When the sword appears, you make a melee spell attack against a target within 5 feet of the sword. On a hit, the target takes Force damage equal to `dice:4d12|noform|noparens|avg` (`4d12`) plus your spellcasting ability modifier.
