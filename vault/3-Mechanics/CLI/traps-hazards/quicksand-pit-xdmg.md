...
|--------|-----------|--------------|
| 5–10 | 15 feet | `dice:1d6\|noform\|noparens\|avg` (`1d6`) feet |
| 11–16 | 20 feet | `dice:1d8\|noform\|noparens\|avg` (`1d8`) feet |
| 17–20 | 30 feet | `dice:1d10\|noform\|noparens\|avg` (`1d10`) feet |
^levels-pit-depth-sinking-rate
